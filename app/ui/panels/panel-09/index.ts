...
'use strict';
// Panel 09 - Adapter Bridge v1.0.0-ENTERPRISE
// Bridge para /public/components/panels/panel-09/index.js

import PanelComponent from '/components/panels/panel-09/index.js';

export const VERSION: string = '1.0.0-ENTERPRISE';
export const MODULE_ID: string = 'panel-09-adapter';
export const PANEL_ID: string = 'panel-09';
...
export * from '/components/panels/panel-09/index.js';
...
export const Panel: PanelAdapter = {
  ...
  info: (): PanelInfo => ({ version: VERSION, moduleId: MODULE_ID, panelId: PANEL_ID, legacy: '/components/panels/panel-09/index.js' })
};
