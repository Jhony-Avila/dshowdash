...
'use strict';
// Panel Audit Trail - Adapter Bridge v1.0.0-ENTERPRISE
// Bridge para /public/components/panels/panel-audit-trail/index.js

import PanelComponent from '/components/panels/panel-audit-trail/index.js';

export const VERSION: string = '1.0.0-ENTERPRISE';
export const MODULE_ID: string = 'panel-audit-trail-adapter';
export const PANEL_ID: string = 'panel-audit-trail';
...
interface PanelAuditTrailAdapter {
...
const TypedPanelComponent = PanelComponent as unknown as PanelComponentModule;

export * from '/components/panels/panel-audit-trail/index.js';
export { PanelComponent };

export const Panel: PanelAuditTrailAdapter = {
  ...
  getLogs: (): AuditLogEntry[] => TypedPanelComponent?.getLogs?.() || [],
  info: (): PanelInfo => ({ version: VERSION, moduleId: MODULE_ID, panelId: PANEL_ID, legacy: '/components/panels/panel-audit-trail/index.js' })
};
