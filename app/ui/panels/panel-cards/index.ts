...
'use strict';
// Panel Cards - Adapter Bridge v1.0.0-ENTERPRISE
// Bridge para /public/components/panels/panel-cards/index.js

import PanelComponent from '/components/panels/panel-cards/index.js';

export const VERSION: string = '1.0.0-ENTERPRISE';
export const MODULE_ID: string = 'panel-cards-adapter';
export const PANEL_ID: string = 'panel-cards';
...
export * from '/components/panels/panel-cards/index.js';
...
export const Panel: PanelAdapter = {
  ...
  info: (): PanelInfo => ({ version: VERSION, moduleId: MODULE_ID, panelId: PANEL_ID, legacy: '/components/panels/panel-cards/index.js' })
};
