...
'use strict';
// panel-permissions-admin - Adapter Bridge v1.0.0-ENTERPRISE
// Bridge para /public/components/panels/panel-permissions-admin/index.js

import PanelComponent from '/components/panels/panel-permissions-admin/index.js';

export const VERSION: string = '1.0.0-ENTERPRISE';
export const MODULE_ID: string = 'panel-permissions-admin-adapter';
export const PANEL_ID: string = 'panel-permissions-admin';
...
export * from '/components/panels/panel-permissions-admin/index.js';
...
export const Panel: PanelAdapter = {
  ...
  info: (): PanelInfo => ({ version: VERSION, moduleId: MODULE_ID, panelId: PANEL_ID, legacy: '/components/panels/panel-permissions-admin/index.js' })
};
