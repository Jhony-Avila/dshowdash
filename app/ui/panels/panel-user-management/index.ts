...
'use strict';
// panel-user-management - Adapter Bridge v1.0.0-ENTERPRISE
// Bridge para /public/components/panels/panel-user-management/index.js

import PanelComponent from '/components/panels/panel-user-management/index.js';

export const VERSION: string = '1.0.0-ENTERPRISE';
export const MODULE_ID: string = 'panel-user-management-adapter';
export const PANEL_ID: string = 'panel-user-management';
...
export * from '/components/panels/panel-user-management/index.js';
...
export const Panel: PanelAdapter = {
  ...
  info: (): PanelInfo => ({ version: VERSION, moduleId: MODULE_ID, panelId: PANEL_ID, legacy: '/components/panels/panel-user-management/index.js' })
};
