...
// ═══════════════════════════════════════════════════════════════
// MODULE: components._shared.icons
// PURPOSE: Global SVG icons registry for the entire application
// ───────────────────────────────────────────────────────────────
// @contract ICONS - ICONS object contains all canonical SVG icons
// @contract GET_ICON - getIcon(name, fallback) returns SVG string
// @contract HAS_ICON - hasIcon(name) checks if icon exists
// @contract HEALTH - healthCheck() and info() for observability
// ───────────────────────────────────────────────────────────────
// IMPORTS: None
// PROVIDES: ICONS, getIcon, hasIcon, VERSION, MODULE_ID, info()
...
export const MODULE_ID = 'components._shared.icons';
...
export function getIcon(name: string, fallback = 'warning') {
