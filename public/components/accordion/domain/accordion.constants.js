...
const MODULE_ID = "components.accordion.domain.constants";
const ACCORDION_INTENTS = Object.freeze({
...
const ACCORDION_EVENTS = Object.freeze({
...
var accordion_constants_default = {
  VERSION,
  MODULE_ID,
  ACCORDION_INTENTS,
  ACCORDION_EVENTS,
...
export {
  ...
  MODULE_ID,
  VERSION,
  accordion_constants_default as default,
  healthCheck,
  info
};
