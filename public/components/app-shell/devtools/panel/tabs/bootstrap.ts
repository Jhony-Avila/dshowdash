...
// ═══════════════════════════════════════════════════════════════
// MODULE: devtools/panel/tabs/bootstrap
// PURPOSE: Renderização da tab Bootstrap no Debug Panel
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   icon, sanitizeAttr, statusClass, networkQualityClass, getBootstrap from ../helpers.js
// EXPORTS:
//   renderBootstrapTab — Retorna HTML da tab Bootstrap
// ═══════════════════════════════════════════════════════════════
/**
 * @module DevtoolsPanelTabBootstrap
 * @description Tab de status do BootstrapV2 no Debug Panel
 * @version 1.0.0-AAA
 * @since 2025-02-02
 */
'use strict';
export const VERSION = '1.0.0-ENTERPRISE';
export const MODULE_ID = 'app-shell.devtools.panel.tabs.bootstrap';

import { icon, sanitizeAttr, statusClass, networkQualityClass, getBootstrap } from '../helpers.js';

/**
 * Renderiza a tab de Bootstrap
