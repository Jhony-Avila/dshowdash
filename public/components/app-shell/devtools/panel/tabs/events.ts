...
// ═══════════════════════════════════════════════════════════════
// MODULE: devtools/panel/tabs/events
// PURPOSE: Renderização da tab Events no Debug Panel
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   icon, sanitizeAttr, getAppShell from ../helpers.js
// EXPORTS:
//   renderEventsTab — Retorna HTML da tab de eventos
// ═══════════════════════════════════════════════════════════════
/**
 * @module DevtoolsPanelTabEvents
 * @description Tab de visualização de eventos no Debug Panel
 * @version 1.0.0-AAA
 * @since 2025-02-02
 */
'use strict';
...
export const MODULE_ID = 'app-shell.devtools.panel.tabs.events';

/**
 * Renderiza a tab de Events
...
export function renderEventsTab() {
    ...
    try {
        ...
        const logHtml = history.reverse().map((e: DynObj) => {
