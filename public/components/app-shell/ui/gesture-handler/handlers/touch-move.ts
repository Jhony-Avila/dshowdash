...
// ═══════════════════════════════════════════════════════════════
// MODULE: gesture-handler/handlers/touch-move
// PURPOSE: Handler de evento touchmove
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
// EXPORTS:
//   handleTouchMove — Handler para touchmove
// ═══════════════════════════════════════════════════════════════
/**
 * @module GestureHandlerTouchMove
 * @description Handler de touchmove para gestos
 * @version 1.0.0-AAA
 * @since 2025-02-02
 */
'use strict';
...
export const MODULE_ID = 'app-shell.ui.gesture-handler.handlers.touch-move';

export function handleTouchMove(event: DynObj) {
    if (!isEnabled()) return;
