...
// ═══════════════════════════════════════════════════════════════
// MODULE: ui/icons
// PURPOSE: Biblioteca de ícones SVG para Debug Panel e Command Palette
// ───────────────────────────────────────────────────────────────
// IMPORTS: none
// EXPORTS:
//   VERSION, MODULE_ID — Identificadores
//   ICONS — Objeto com todos os ícones SVG
//   icon — Retorna ícone com tamanho customizado
//   iconSpan — Retorna ícone em span
...
export const MODULE_ID = 'app-shell-icons';
...
export function icon(name: string, size: DynObj) {
    const svg = (ICONS as DynObj)[name];
    if (!svg) return '';
    if (size) {
...
export function iconSpan(name: string, size: DynObj, className: string) {
...
export default { VERSION, MODULE_ID, ICONS, icon, iconSpan, healthCheck, info };
