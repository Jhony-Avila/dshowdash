...
// ═══════════════════════════════════════════════════════════════
// MODULE: notification-center/subscription
// PURPOSE: Sistema de subscription para eventos de notificação
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
// ═══════════════════════════════════════════════════════════════
/**
 * @module NotificationCenterSubscription
 * @description Pub/Sub para eventos de notificação
 * @version 1.0.0-AAA
 * @since 2025-02-02
 */
'use strict';
...
export const MODULE_ID = 'app-shell.ui.notification-center.subscription';
...
/**
 * Registra callback para eventos de notificação
