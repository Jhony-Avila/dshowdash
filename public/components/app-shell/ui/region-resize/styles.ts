...
// ═══════════════════════════════════════════════════════════════
// MODULE: region-resize/styles
// PURPOSE: Injeção de CSS para handles de resize
// ───────────────────────────────────────────────────────────────
// IMPORTS: none
// EXPORTS:
//   injectStyles — Injeta CSS de resize handles
// BROWSER APIs: document.createElement, document.head
// SIDE EFFECTS: Auto-executa injectStyles() no load
// ═══════════════════════════════════════════════════════════════
/**
 * @module RegionResizeStyles
 * @description CSS para handles de resize
...
export const MODULE_ID = 'app-shell.ui.region-resize.styles';

/**
 * Injeta estilos CSS de resize
 */
