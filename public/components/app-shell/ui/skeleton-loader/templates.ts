...
// ═══════════════════════════════════════════════════════════════
// MODULE: skeleton-loader/templates
// PURPOSE: Configurações de templates para skeleton loaders
// ───────────────────────────────────────────────────────────────
// IMPORTS: none
// EXPORTS:
//   templateConfigs — Objeto com configurações de templates
// ═══════════════════════════════════════════════════════════════
/**
 * @module SkeletonLoaderTemplates
 * @description Templates predefinidos para skeletons
 * @version 1.0.0-AAA
 * @since 2025-02-02
 */
'use strict';
...
export const MODULE_ID = 'app-shell.ui.skeleton-loader.templates';
