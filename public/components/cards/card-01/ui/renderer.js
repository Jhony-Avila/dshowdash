...
const MODULE_ID = "components.cards.card-01.ui.renderer";
function renderSkeleton() {
  return '<div class="card-header skeleton-header"><div class="skeleton skeleton-header-icon"></div><div class="skeleton skeleton-header-text"></div></div><div class="card-body"><div class="skeleton skeleton-value"></div><div class="skeleton skeleton-label"></div><div class="skeleton skeleton-sparkline"></div></div><div class="card-meta"><div class="skeleton skeleton-meta-item"></div><div class="skeleton skeleton-meta-item"></div></div><span class="sr-only">Carregando taxa di\xE1ria...</span>';
}
function renderCard() {
  return '<div class="card-header"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><polyline points="20 6 9 17 4 12"></polyline></svg><span>Taxa Di\xE1ria</span></div><div class="card-body"><div class="card-value" data-el="percent">--</div><div class="card-label">Performance de hoje</div><div class="sparkline-container" data-el="sparkline"></div></div><div class="card-meta"><span>Sucesso: <strong data-el="ok">--</strong></span><span>Erros: <strong data-el="err">--</strong></span></div><div class="card-status" data-el="status" role="status" aria-live="polite"></div>';
}
