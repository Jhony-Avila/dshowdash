...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-02.core.constants
// PURPOSE: Card 02 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-02.core.constants';
export const CARD_ID = 'card-02';
export const CARD_NAME = 'Taxa de Sucesso Global';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-02/api.php',
