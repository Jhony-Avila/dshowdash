...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-03.ui.renderer
// PURPOSE: HTML template rendering for Card 03 states (Performance)
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-03.ui.renderer';
...
export const renderCard = () => `
  ...
  <div class="card-body">
    ...
    <div class="card-label">Score do dia</div>
  </div>
...
export const info = () => ({ moduleId: MODULE_ID, version: VERSION, exports: ['renderSkeleton', 'renderCard', 'renderError'], timestamp: Date.now() });
