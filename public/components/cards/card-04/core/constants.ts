...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-04.core.constants
// PURPOSE: Card 04 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-04.core.constants';
export const CARD_ID = 'card-04';
export const CARD_NAME = 'Pico do Dia';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-04/api.php',
