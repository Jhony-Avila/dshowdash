...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-05.core.constants
// PURPOSE: Card 05 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-05.core.constants';
export const CARD_ID = 'card-05';
export const CARD_NAME = 'Scripts Completados';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-05/api.php',
