...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-05.ui.renderer
// PURPOSE: HTML template rendering for Card 05 states
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-05.ui.renderer';
...
export const renderSkeleton = () => `
  ...
  <span class="sr-only">Carregando scripts completados...</span>`;
...
export const renderCard = () => `
  ...
  <div class="card-body">
    ...
    <div class="card-label">Scripts finalizados</div>
  </div>
