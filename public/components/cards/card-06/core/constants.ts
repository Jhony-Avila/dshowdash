...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-06.core.constants
// PURPOSE: Card 06 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-06.core.constants';
export const CARD_ID = 'card-06';
export const CARD_NAME = 'Scripts com Falhas';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-06/api.php',
