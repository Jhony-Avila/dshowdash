...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-06.utils.formatters
// PURPOSE: Number formatting and API data parsing for Card 06 (Failed)
// ───────────────────────────────────────────────────────────────
// @contract FORMAT_NUMBER - formatNumber(value) returns formatted pt-BR number
// @contract PARSE_API - parseApiData(data) extracts failed count from API
...
export const MODULE_ID = 'components.cards.card-06.utils.formatters';
