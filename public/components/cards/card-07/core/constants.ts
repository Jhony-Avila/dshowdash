...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-07.core.constants
// PURPOSE: Card 07 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
// @changelog v9.0.0-P18EC: Migrated to CARD_INTENTS/CARD_EVENTS
// ═══════════════════════════════════════════════════════════════
'use strict';
...
export const MODULE_ID = 'components.cards.card-07.core.constants';
export const CARD_ID = 'card-07';
export const CARD_NAME = 'Em Execução';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-07/api.php',
