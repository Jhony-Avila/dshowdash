...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-07.ui.renderer
// PURPOSE: HTML template rendering for Card 07 states (Running Scripts)
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-07.ui.renderer';
...
export function renderSkeleton() {
  ...
  '</div>' +
  '<span class="sr-only">Carregando scripts em execução...</span>';
}
...
export function renderCard() {
  ...
  '<div class="card-body">' +
    ...
    '<div class="card-label">Scripts rodando agora</div>' +
  '</div>' +
