...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-08.core.constants
// PURPOSE: Card 08 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-08.core.constants';
export const CARD_ID = 'card-08';
export const CARD_NAME = 'Média por Hora';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-08/api.php',
