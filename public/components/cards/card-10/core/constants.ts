...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-10.core.constants
// PURPOSE: Card 10 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-10.core.constants';
export const CARD_ID = 'card-10';
export const CARD_NAME = 'Performance Score';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-10/api.php',
