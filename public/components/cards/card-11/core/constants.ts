...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-11.core.constants
// PURPOSE: Card 11 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-11.core.constants';
export const CARD_ID = 'card-11';
export const CARD_NAME = 'Tempo Médio';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-11/api.php',
