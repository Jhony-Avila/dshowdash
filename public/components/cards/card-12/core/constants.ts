...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-12.core.constants
// PURPOSE: Card 12 constants, config, states and events
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-12.core.constants';
export const CARD_ID = 'card-12';
export const CARD_NAME = 'Taxa de Cache';

export const CONFIG = Object.freeze({
  API_ENDPOINT: '/api/modules/cards/card-12/api.php',
