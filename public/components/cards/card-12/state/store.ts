...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-12.state.store
// PURPOSE: Reactive state management for Card 12 with lock support
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-12.state.store';
...
export function createStore(cardId: string) { return new CardState(cardId); }
