...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-12.ui.renderer
// PURPOSE: HTML template rendering for Card 12 states (Cache Hit Rate)
// ───────────────────────────────────────────────────────────────
...
export const MODULE_ID = 'components.cards.card-12.ui.renderer';
...
export function renderSkeleton() {
  ...
  '</div>' +
  '<span class="sr-only">Carregando taxa de cache...</span>';
}
...
export function renderCard() {
  ...
  '</div>' +
  '<div class="card-body">' +
    '<div class="card-value" data-el="rate">--</div>' +
