...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.cards.card-12.utils.formatters
// PURPOSE: Percent formatting and API data parsing for Card 12 (Cache Hit Rate)
// ───────────────────────────────────────────────────────────────
// @contract FORMAT_PERCENT - formatPercent(value) returns formatted percentage
// @contract PARSE_API - parseApiData(data) extracts cacheHitRate from API
...
export const MODULE_ID = 'components.cards.card-12.utils.formatters';
...
export function parseApiData(data: unknown) {
  ...
  const value = apiData.hit_rate !== undefined ? parseFloat(apiData.hit_rate) : (apiData.value !== undefined ? parseFloat(apiData.value) : 0);
