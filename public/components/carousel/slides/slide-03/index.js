...
const MODULE_ID = "carousel-slide-03";
const SLIDE_ID = "slide-03";
function render() {
  return `<div class="slide slide-03"><h2>Slide 3</h2></div>`;
}
function init() {
  return true;
}
...
var slide_03_default = { SLIDE_ID, render, init, destroy, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  SLIDE_ID,
  VERSION,
  slide_03_default as default,
  destroy,
  healthCheck,
  info,
  init,
