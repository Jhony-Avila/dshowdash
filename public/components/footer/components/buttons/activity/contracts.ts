...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-activity-contracts
// PURPOSE: Footer activity Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-activity-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'activity', area: 'footer', label: 'activity', icon: 'activity', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:activity', meta: {} };
