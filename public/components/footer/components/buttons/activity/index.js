...
const MODULE_ID = "footer/components/buttons/activity";
...
function getInstance() {
  if (!_instance) _instance = new ActivityButton();
  return _instance;
}
...
var activity_default = { ActivityButton, getInstance, createActivityButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
