...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-activity-template
...
const MODULE_ID = 'footer-button-activity-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'activity', label = 'Atividade', icon = 'activity', kind = 'decorative' } = config;
