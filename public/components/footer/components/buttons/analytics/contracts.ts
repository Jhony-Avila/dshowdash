...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-analytics-contracts
// PURPOSE: Footer analytics Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-analytics-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'analytics', area: 'footer', label: 'analytics', icon: 'analytics', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:analytics', meta: {} };
