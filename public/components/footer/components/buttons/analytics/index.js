...
const MODULE_ID = "footer/components/buttons/analytics";
...
function getInstance() {
  if (!_instance) _instance = new AnalyticsButton();
  return _instance;
}
function createAnalyticsButton() {
  return new AnalyticsButton();
}
...
var analytics_default = { AnalyticsButton, getInstance, createAnalyticsButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
