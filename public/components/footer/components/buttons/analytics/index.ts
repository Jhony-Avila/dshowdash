...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/analytics
// PURPOSE: Footer Analytics Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createAnalyticsButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/analytics';
...
export function getInstance() { if (!_instance) _instance = new AnalyticsButton(); return _instance; }
export function createAnalyticsButton() { return new AnalyticsButton(); }
...
export default { AnalyticsButton, getInstance, createAnalyticsButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
