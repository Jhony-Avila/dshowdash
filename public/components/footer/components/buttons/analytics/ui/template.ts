...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-analytics-template
...
const MODULE_ID = 'footer-button-analytics-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'analytics', label = 'Analytics', icon = 'analytics', kind = 'decorative' } = config;
