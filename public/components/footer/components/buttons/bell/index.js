...
const MODULE_ID = "footer/components/buttons/bell";
class BellButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new BellButton();
  return _instance;
}
function createBellButton() {
  return new BellButton();
}
...
var bell_default = { BellButton, getInstance, createBellButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createBellButton,
