...
const MODULE_ID = "footer/components/buttons/bookmark";
...
function getInstance() {
  if (!_instance) _instance = new BookmarkButton();
  return _instance;
}
...
var bookmark_default = { BookmarkButton, getInstance, createBookmarkButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
