...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-bookmark-template
...
const MODULE_ID = 'footer-button-bookmark-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'bookmark', label = 'Favoritos', icon = 'bookmark', kind = 'decorative' } = config;
