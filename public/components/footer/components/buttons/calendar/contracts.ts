...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-calendar-contracts
// PURPOSE: Footer calendar Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-calendar-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'calendar', area: 'footer', label: 'calendar', icon: 'calendar', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:calendar', meta: {} };
