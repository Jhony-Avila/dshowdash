...
const MODULE_ID = "footer/components/buttons/calendar";
...
function getInstance() {
  if (!_instance) _instance = new CalendarButton();
  return _instance;
}
...
var calendar_default = { CalendarButton, getInstance, createCalendarButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
