...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-calendar-template
...
const MODULE_ID = 'footer-button-calendar-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'calendar', label = 'Calendário', icon = 'calendar', kind = 'decorative' } = config;
