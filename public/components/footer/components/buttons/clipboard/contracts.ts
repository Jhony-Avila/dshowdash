...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-clipboard-contracts
// PURPOSE: Footer clipboard Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-clipboard-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'clipboard', area: 'footer', label: 'clipboard', icon: 'clipboard', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:clipboard', meta: {} };
