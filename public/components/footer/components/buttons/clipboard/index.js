...
const MODULE_ID = "footer/components/buttons/clipboard";
...
function getInstance() {
  if (!_instance) _instance = new ClipboardButton();
  return _instance;
}
function createClipboardButton() {
  return new ClipboardButton();
}
...
var clipboard_default = { ClipboardButton, getInstance, createClipboardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
