...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/clipboard
// PURPOSE: Footer Relatórios Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createClipboardButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/clipboard';
...
export function getInstance() { if (!_instance) _instance = new ClipboardButton(); return _instance; }
export function createClipboardButton() { return new ClipboardButton(); }
...
export default { ClipboardButton, getInstance, createClipboardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
