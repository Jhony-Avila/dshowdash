...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-clipboard-template
...
const MODULE_ID = 'footer-button-clipboard-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'clipboard', label = 'Clipboard', icon = 'clipboard', kind = 'decorative' } = config;
