...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-cloud-contracts
// PURPOSE: Footer cloud Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-cloud-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'cloud', area: 'footer', label: 'cloud', icon: 'cloud', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:cloud', meta: {} };
