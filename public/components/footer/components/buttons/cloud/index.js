...
const MODULE_ID = "footer/components/buttons/cloud";
class CloudButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new CloudButton();
  return _instance;
}
...
var cloud_default = { CloudButton, getInstance, createCloudButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createCloudButton,
