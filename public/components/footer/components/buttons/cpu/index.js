...
const MODULE_ID = "footer/components/buttons/cpu";
class CpuButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new CpuButton();
  return _instance;
}
function createCpuButton() {
  return new CpuButton();
}
...
var cpu_default = { CpuButton, getInstance, createCpuButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createCpuButton,
