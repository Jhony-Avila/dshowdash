...
const BUTTON_CONFIG = { id: "credit-card", area: "footer", label: "credit-card", icon: "credit-card", kind: "navigation" };
const EMITTED_EVENTS = [UI_EVENTS.ACTION];
const ACTION_PAYLOAD = { actionId: "footer:credit-card", meta: {} };
function getMetrics() {
