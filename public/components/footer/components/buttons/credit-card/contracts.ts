...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-credit-card-contracts
// PURPOSE: Footer credit-card Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-credit-card-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'credit-card', area: 'footer', label: 'credit-card', icon: 'credit-card', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:credit-card', meta: {} };
