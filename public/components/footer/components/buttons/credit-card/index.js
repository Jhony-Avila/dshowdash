...
const MODULE_ID = "footer/components/buttons/credit-card";
...
function getInstance() {
  if (!_instance) _instance = new CreditCardButton();
  return _instance;
}
function createCreditCardButton() {
  return new CreditCardButton();
}
...
var credit_card_default = { CreditCardButton, getInstance, createCreditCardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
