...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/credit-card
// PURPOSE: Footer Financeiro Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createCreditCardButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/credit-card';
...
export function getInstance() { if (!_instance) _instance = new CreditCardButton(); return _instance; }
export function createCreditCardButton() { return new CreditCardButton(); }
...
export default { CreditCardButton, getInstance, createCreditCardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
