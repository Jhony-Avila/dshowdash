...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-credit-card-template
...
const MODULE_ID = 'footer-button-credit-card-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'credit-card', label = 'Cartão', icon = 'credit-card', kind = 'decorative' } = config;
