...
const MODULE_ID = "footer/components/buttons/dashboard";
...
function getInstance() {
  if (!_instance) _instance = new DashboardButton();
  return _instance;
}
...
var dashboard_default = { DashboardButton, getInstance, createDashboardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
