...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/dashboard
// PURPOSE: Footer Dashboard Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createDashboardButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/dashboard';
...
export function getInstance() { if (!_instance) _instance = new DashboardButton(); return _instance; }
export function createDashboardButton() { return new DashboardButton(); }
...
export default { DashboardButton, getInstance, createDashboardButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
