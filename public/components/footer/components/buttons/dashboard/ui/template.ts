...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-dashboard-template
...
const MODULE_ID = 'footer-button-dashboard-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'dashboard', label = 'Dashboard', icon = 'dashboard', kind = 'decorative' } = config;
