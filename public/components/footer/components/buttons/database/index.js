...
const MODULE_ID = "footer/components/buttons/database";
...
function getInstance() {
  if (!_instance) _instance = new DatabaseButton();
  return _instance;
}
function createDatabaseButton() {
  return new DatabaseButton();
}
...
var database_default = { DatabaseButton, getInstance, createDatabaseButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
