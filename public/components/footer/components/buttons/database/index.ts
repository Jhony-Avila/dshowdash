...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/database
// PURPOSE: Footer Database Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createDatabaseButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/database';
...
export function getInstance() { if (!_instance) _instance = new DatabaseButton(); return _instance; }
export function createDatabaseButton() { return new DatabaseButton(); }
...
export default { DatabaseButton, getInstance, createDatabaseButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
