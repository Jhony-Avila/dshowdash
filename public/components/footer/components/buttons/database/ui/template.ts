...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-database-template
...
const MODULE_ID = 'footer-button-database-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'database', label = 'Database', icon = 'database', kind = 'decorative' } = config;
