...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-folder-contracts
// PURPOSE: Footer folder Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-folder-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'folder', area: 'footer', label: 'folder', icon: 'folder', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:folder', meta: {} };
