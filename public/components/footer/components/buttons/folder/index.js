...
const MODULE_ID = "footer/components/buttons/folder";
class FolderButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new FolderButton();
  return _instance;
}
function createFolderButton() {
  return new FolderButton();
}
...
var folder_default = { FolderButton, getInstance, createFolderButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createFolderButton,
