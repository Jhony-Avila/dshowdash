...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-globe-contracts
// PURPOSE: Footer globe Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-globe-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'globe', area: 'footer', label: 'globe', icon: 'globe', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:globe', meta: {} };
