...
const MODULE_ID = "footer/components/buttons/globe";
class GlobeButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new GlobeButton();
  return _instance;
}
function createGlobeButton() {
  return new GlobeButton();
}
...
var globe_default = { GlobeButton, getInstance, createGlobeButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createGlobeButton,
