...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-hard-drive-contracts
// PURPOSE: Footer hard-drive Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-hard-drive-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'hard-drive', area: 'footer', label: 'hard-drive', icon: 'hard-drive', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:hard-drive', meta: {} };
