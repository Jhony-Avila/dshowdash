...
const MODULE_ID = "footer/components/buttons/hard-drive";
...
function getInstance() {
  if (!_instance) _instance = new HardDriveButton();
  return _instance;
}
function createHardDriveButton() {
  return new HardDriveButton();
}
...
var hard_drive_default = { HardDriveButton, getInstance, createHardDriveButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createHardDriveButton,
