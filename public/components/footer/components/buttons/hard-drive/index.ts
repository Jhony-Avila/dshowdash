...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/hard-drive
// PURPOSE: Footer Storage Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createHardDriveButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/hard-drive';

class HardDriveButton {
  [key: string]: any;
  constructor() {
    this._element = null;
    this._hostEl = null;
...
export function getInstance() { if (!_instance) _instance = new HardDriveButton(); return _instance; }
export function createHardDriveButton() { return new HardDriveButton(); }
...
export default { HardDriveButton, getInstance, createHardDriveButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
