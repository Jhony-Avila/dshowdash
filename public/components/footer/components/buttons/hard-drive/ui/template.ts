...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-hard-drive-template
...
const MODULE_ID = 'footer-button-hard-drive-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'hard-drive', label = 'Disco', icon = 'hard-drive', kind = 'decorative' } = config;
