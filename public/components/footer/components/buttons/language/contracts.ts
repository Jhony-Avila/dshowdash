...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-language-contracts
// PURPOSE: Footer language Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-language-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'language', area: 'footer', label: 'language', icon: 'language', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:language', meta: {} };
