...
const MODULE_ID = "footer/components/buttons/language";
...
function getInstance() {
  if (!_instance) _instance = new LanguageButton();
  return _instance;
}
...
var language_default = { LanguageButton, getInstance, createLanguageButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
