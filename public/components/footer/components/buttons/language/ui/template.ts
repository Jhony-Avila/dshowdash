...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-language-template
...
const MODULE_ID = 'footer-button-language-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'language', label = 'Idioma', icon = 'language', kind = 'decorative' } = config;
