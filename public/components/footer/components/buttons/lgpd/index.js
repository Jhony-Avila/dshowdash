...
const MODULE_ID = "footer/components/buttons/lgpd";
class LgpdLink {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new LgpdLink();
  return _instance;
}
function createLgpdLink() {
  return new LgpdLink();
}
...
var lgpd_default = { LgpdLink, getInstance, createLgpdLink, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createLgpdLink,
  lgpd_default as default,
  getInstance,
  healthCheck,
  info,
  init,
