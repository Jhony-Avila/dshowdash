...
const MODULE_ID = "footer/components/buttons/link";
class LinkButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new LinkButton();
  return _instance;
}
...
var link_default = { LinkButton, getInstance, createLinkButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createLinkButton,
