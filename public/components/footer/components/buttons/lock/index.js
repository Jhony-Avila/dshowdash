...
const MODULE_ID = "footer/components/buttons/lock";
class LockButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new LockButton();
  return _instance;
}
function createLockButton() {
  return new LockButton();
}
...
var lock_default = { LockButton, getInstance, createLockButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createLockButton,
