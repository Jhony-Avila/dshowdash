...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/lock
// PURPOSE: Footer Privacidade Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createLockButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/lock';
...
export function getInstance() { if (!_instance) _instance = new LockButton(); return _instance; }
export function createLockButton() { return new LockButton(); }
...
export default { LockButton, getInstance, createLockButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
