...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-logout-contracts
// PURPOSE: Footer logout Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-logout-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'logout', area: 'footer', label: 'logout', icon: 'logout', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:logout', meta: {} };
