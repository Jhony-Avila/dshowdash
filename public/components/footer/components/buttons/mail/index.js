...
const MODULE_ID = "footer/components/buttons/mail";
class MailButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new MailButton();
  return _instance;
}
function createMailButton() {
  return new MailButton();
}
...
var mail_default = { MailButton, getInstance, createMailButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createMailButton,
