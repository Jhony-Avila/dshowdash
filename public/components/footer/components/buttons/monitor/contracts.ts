...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-monitor-contracts
// PURPOSE: Footer monitor Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-monitor-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'monitor', area: 'footer', label: 'monitor', icon: 'monitor', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:monitor', meta: {} };
