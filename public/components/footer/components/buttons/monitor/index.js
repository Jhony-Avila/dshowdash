...
const MODULE_ID = "footer/components/buttons/monitor";
class MonitorButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new MonitorButton();
  return _instance;
}
function createMonitorButton() {
  return new MonitorButton();
}
...
var monitor_default = { MonitorButton, getInstance, createMonitorButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createMonitorButton,
