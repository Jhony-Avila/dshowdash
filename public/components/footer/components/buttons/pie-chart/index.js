...
const MODULE_ID = "footer/components/buttons/pie-chart";
...
function getInstance() {
  if (!_instance) _instance = new PieChartButton();
  return _instance;
}
function createPieChartButton() {
  return new PieChartButton();
}
...
var pie_chart_default = { PieChartButton, getInstance, createPieChartButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
