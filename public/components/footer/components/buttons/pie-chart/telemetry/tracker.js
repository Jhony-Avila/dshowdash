...
function healthCheck() {
  const ps = Ports.snapshot();
  return { status: ps._initialized ? "HEALTHY" : "DEGRADED", version: VERSION, moduleId: MODULE_ID, checks: { trackerReady: true, portsInitialized: ps._initialized }, metrics: getMetrics(), p18IntentsAvailable: true };
}
