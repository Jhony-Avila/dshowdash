...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-pie-chart-template
...
const MODULE_ID = 'footer-button-pie-chart-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'pie-chart', label = 'Gráfico', icon = 'pie-chart', kind = 'decorative' } = config;
