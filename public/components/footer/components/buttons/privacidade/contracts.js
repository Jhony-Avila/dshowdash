...
const BUTTON_CONFIG = { id: "privacidade", area: "footer", label: "privacidade", icon: "privacidade", kind: "navigation" };
const EMITTED_EVENTS = [UI_EVENTS.ACTION];
const ACTION_PAYLOAD = { actionId: "footer:privacidade", meta: {} };
function getMetrics() {
