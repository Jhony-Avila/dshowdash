...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-privacidade-contracts
// PURPOSE: Footer privacidade Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-privacidade-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'privacidade', area: 'footer', label: 'privacidade', icon: 'privacidade', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:privacidade', meta: {} };
