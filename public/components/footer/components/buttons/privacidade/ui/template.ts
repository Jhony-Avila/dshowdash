...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-privacidade-template
...
const MODULE_ID = 'footer-button-privacidade-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'privacidade', label = 'Privacidade', icon = 'privacidade', kind = 'decorative' } = config;
