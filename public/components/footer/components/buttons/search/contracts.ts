...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-search-contracts
// PURPOSE: Footer search Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-search-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'search', area: 'footer', label: 'search', icon: 'search', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:search', meta: {} };
