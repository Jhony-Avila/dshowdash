...
const MODULE_ID = "footer/components/buttons/search";
class SearchButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new SearchButton();
  return _instance;
}
...
var search_default = { SearchButton, getInstance, createSearchButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createSearchButton,
