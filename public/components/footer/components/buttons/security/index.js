...
const MODULE_ID = "footer/components/buttons/security";
...
function getInstance() {
  if (!_instance) _instance = new SecurityButton();
  return _instance;
}
function createSecurityButton() {
  return new SecurityButton();
}
...
var security_default = { SecurityButton, getInstance, createSecurityButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
