...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-security-template
...
const MODULE_ID = 'footer-button-security-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'security', label = 'Segurança', icon = 'security', kind = 'decorative' } = config;
