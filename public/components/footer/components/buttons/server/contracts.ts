...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-server-contracts
// PURPOSE: Footer server Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-server-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'server', area: 'footer', label: 'server', icon: 'server', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:server', meta: {} };
