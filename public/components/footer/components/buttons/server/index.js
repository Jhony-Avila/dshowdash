...
const MODULE_ID = "footer/components/buttons/server";
class ServerButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new ServerButton();
  return _instance;
}
function createServerButton() {
  return new ServerButton();
}
...
var server_default = { ServerButton, getInstance, createServerButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createServerButton,
