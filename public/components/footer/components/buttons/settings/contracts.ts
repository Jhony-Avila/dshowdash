...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-settings-contracts
// PURPOSE: Footer settings Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-settings-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'settings', area: 'footer', label: 'settings', icon: 'settings', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:settings', meta: {} };
