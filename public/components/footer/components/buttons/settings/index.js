...
const MODULE_ID = "footer/components/buttons/settings";
...
function getInstance() {
  if (!_instance) _instance = new SettingsButton();
  return _instance;
}
...
var settings_default = { SettingsButton, getInstance, createSettingsButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
