...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-settings-template
...
const MODULE_ID = 'footer-button-settings-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'settings', label = 'Configurações', icon = 'settings', kind = 'decorative' } = config;
