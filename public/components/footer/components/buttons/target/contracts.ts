...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-target-contracts
// PURPOSE: Footer target Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-target-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'target', area: 'footer', label: 'target', icon: 'target', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:target', meta: {} };
