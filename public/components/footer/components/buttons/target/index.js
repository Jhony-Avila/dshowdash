...
const MODULE_ID = "footer/components/buttons/target";
class TargetButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new TargetButton();
  return _instance;
}
function createTargetButton() {
  return new TargetButton();
}
...
var target_default = { TargetButton, getInstance, createTargetButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createTargetButton,
