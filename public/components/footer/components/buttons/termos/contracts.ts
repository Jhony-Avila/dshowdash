...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-termos-contracts
// PURPOSE: Footer termos Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-termos-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'termos', area: 'footer', label: 'termos', icon: 'termos', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:termos', meta: {} };
