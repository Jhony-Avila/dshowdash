...
const MODULE_ID = "footer/components/buttons/termos";
class TermosLink {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new TermosLink();
  return _instance;
}
function createTermosLink() {
  return new TermosLink();
}
...
var termos_default = { TermosLink, getInstance, createTermosLink, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createTermosLink,
  termos_default as default,
  getInstance,
  healthCheck,
  info,
  init,
