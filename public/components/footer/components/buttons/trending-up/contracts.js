...
const BUTTON_CONFIG = { id: "trending-up", area: "footer", label: "trending-up", icon: "trending-up", kind: "navigation" };
const EMITTED_EVENTS = [UI_EVENTS.ACTION];
const ACTION_PAYLOAD = { actionId: "footer:trending-up", meta: {} };
function getMetrics() {
