...
const MODULE_ID = "footer/components/buttons/trending-up";
...
function getInstance() {
  if (!_instance) _instance = new TrendingUpButton();
  return _instance;
}
function createTrendingUpButton() {
  return new TrendingUpButton();
}
...
var trending_up_default = { TrendingUpButton, getInstance, createTrendingUpButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createTrendingUpButton,
