...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-trending-up-template
...
const MODULE_ID = 'footer-button-trending-up-template';
...
export function createTemplate(config: { id?: string; label?: string; icon?: string; kind?: string } = {}) {
  _metrics.renders++;
  const { id = 'trending-up', label = 'Tendências', icon = 'trending-up', kind = 'decorative' } = config;
