...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-button-users-contracts
// PURPOSE: Footer users Button - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-button-users-contracts';
const VERSION = '1.2.0-P18EC';

export const BUTTON_CONFIG = { id: 'users', area: 'footer', label: 'users', icon: 'users', kind: 'navigation' };
export const EMITTED_EVENTS = [UI_EVENTS.ACTION];
export const ACTION_PAYLOAD = { actionId: 'footer:users', meta: {} };
