...
const MODULE_ID = "footer/components/buttons/users";
class UsersButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new UsersButton();
  return _instance;
}
function createUsersButton() {
  return new UsersButton();
}
...
var users_default = { UsersButton, getInstance, createUsersButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createUsersButton,
