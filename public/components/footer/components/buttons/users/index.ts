...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/buttons/users
// PURPOSE: Footer Usuários Button Component P3 AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createUsersButton() — exported function
//
...
export const MODULE_ID = 'footer/components/buttons/users';
...
export function getInstance() { if (!_instance) _instance = new UsersButton(); return _instance; }
export function createUsersButton() { return new UsersButton(); }
...
export default { UsersButton, getInstance, createUsersButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
