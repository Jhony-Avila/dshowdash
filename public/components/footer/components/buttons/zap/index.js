...
const MODULE_ID = "footer/components/buttons/zap";
class ZapButton {
  constructor() {
    this._element = null;
    this._hostEl = null;
...
function getInstance() {
  if (!_instance) _instance = new ZapButton();
  return _instance;
}
function createZapButton() {
  return new ZapButton();
}
...
var zap_default = { ZapButton, getInstance, createZapButton, init, mount, unmount, healthCheck, info, VERSION, MODULE_ID };
export {
  MODULE_ID,
  VERSION,
  createZapButton,
