...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/icon-activity
// PURPOSE: Footer Icon Activity - Enterprise v1.0.0
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
export const MODULE_ID = 'footer/components/icon-activity';
...
export class IconActivity {
  ...
  render() { this.element = document.createElement('button'); this.element.className = 'icon-activity-component dsd-footer__icon-btn'; this.element.title = 'Activity'; this.element.setAttribute('data-uarps-trigger', 'trigger:footer:activity'); this.element.setAttribute('aria-label', 'Activity'); this.element.innerHTML = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>`; this.container.appendChild(this.element); }
