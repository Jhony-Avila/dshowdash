...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/icon-credit-card
// PURPOSE: Footer Icon Credit Card - Enterprise v1.0.0
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
export const MODULE_ID = 'footer/components/icon-credit-card';
...
export class IconCreditCard {
  ...
  render() { this.element = document.createElement('button'); this.element.className = 'icon-credit-card-component dsd-footer__icon-btn'; this.element.title = 'Credit Card'; this.element.setAttribute('data-uarps-trigger', 'trigger:footer:credit-card'); this.element.setAttribute('aria-label', 'Credit Card'); this.element.innerHTML = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>`; this.container.appendChild(this.element); }
