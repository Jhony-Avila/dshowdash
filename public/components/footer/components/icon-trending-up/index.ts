...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/icon-trending-up
// PURPOSE: Footer Icon Trending Up - Enterprise v1.0.0
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
export const MODULE_ID = 'footer/components/icon-trending-up';
...
export class IconTrendingUp {
  ...
  render() { this.element = document.createElement('button'); this.element.className = 'icon-trending-up-component dsd-footer__icon-btn'; this.element.title = 'Tendências'; this.element.setAttribute('data-uarps-trigger', 'trigger:footer:trending-up'); this.element.setAttribute('aria-label', 'Tendências'); this.element.innerHTML = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>`; this.container.appendChild(this.element); }
