...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-activity-contracts
// PURPOSE: activity Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-activity-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.activity:mounted',
    UNMOUNTED: 'footer.icon.activity:unmounted',
    RENDERED: 'footer.icon.activity:rendered',
    CLICKED: 'footer.icon.activity:clicked',
    ERROR: 'footer.icon.activity:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'activity' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--activity', svg: 'dsd-icon__svg' }
};
