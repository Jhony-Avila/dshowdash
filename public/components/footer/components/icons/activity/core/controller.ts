...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-activity-controller
// PURPOSE: activity Icon - Controller
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-activity-controller';
...
export const Controller = {
  ...
  async mount(container: HTMLElement|null, props: Record<string, unknown> = {}) {
    ...
    if (v.props.clickable) {
      const el = container.querySelector('.dsd-icon--activity');
