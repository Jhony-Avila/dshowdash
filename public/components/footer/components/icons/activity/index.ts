...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-activity
// PURPOSE: activity Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-activity';
...
function _log(level: string, ...args: unknown[]) {
  if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') {
    ...
    (Logger as Record<string,unknown>)[level as string]('[ACTIVITY]', ...args);
  }
}
...
if (typeof window !== 'undefined') {
  ...
  window.__dev.footerIconActivity = { getVersion: () => VERSION, info: () => ActivityIcon.info(), healthCheck: () => ActivityIcon.healthCheck() };
}

export default ActivityIcon;
export { ActivityIcon, MODULE_ID, VERSION };
