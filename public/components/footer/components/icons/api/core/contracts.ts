...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-api-contracts
// PURPOSE: api Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-api-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.api:mounted',
    UNMOUNTED: 'footer.icon.api:unmounted',
    RENDERED: 'footer.icon.api:rendered',
    CLICKED: 'footer.icon.api:clicked',
    ERROR: 'footer.icon.api:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'api' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--api', svg: 'dsd-icon__svg' }
};
