...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconAtSign = { getVersion: () => VERSION, info: () => AtSignIcon.info(), healthCheck: () => AtSignIcon.healthCheck() };
}
var at_sign_default = AtSignIcon;
export {
  AtSignIcon,
  MODULE_ID,
  VERSION,
