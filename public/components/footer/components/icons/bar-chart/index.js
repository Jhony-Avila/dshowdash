...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconBarChart = { getVersion: () => VERSION, info: () => BarChartIcon.info(), healthCheck: () => BarChartIcon.healthCheck() };
}
var bar_chart_default = BarChartIcon;
export {
  BarChartIcon,
  MODULE_ID,
  VERSION,
  bar_chart_default as default
};
