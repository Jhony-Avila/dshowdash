...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-box-contracts
// PURPOSE: box Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
const MODULE_ID = 'footer-icon-box-contracts';
const VERSION = '1.1.0-ENTERPRISE';
export const CONTRACTS = {
  EVENTS: { MOUNTED: 'footer.icon.box:mounted', UNMOUNTED: 'footer.icon.box:unmounted', RENDERED: 'footer.icon.box:rendered', CLICKED: 'footer.icon.box:clicked', ERROR: 'footer.icon.box:error' },
  ...
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--box', svg: 'dsd-icon__svg' }
};
