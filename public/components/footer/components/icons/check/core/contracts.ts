...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-check-contracts
// PURPOSE: check Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-check-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.check:mounted',
    UNMOUNTED: 'footer.icon.check:unmounted',
    RENDERED: 'footer.icon.check:rendered',
    CLICKED: 'footer.icon.check:clicked',
    ERROR: 'footer.icon.check:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'check' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--check', svg: 'dsd-icon__svg' }
};
