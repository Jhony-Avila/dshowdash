...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-clock-contracts
// PURPOSE: clock Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-clock-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.clock:mounted',
    UNMOUNTED: 'footer.icon.clock:unmounted',
    RENDERED: 'footer.icon.clock:rendered',
    CLICKED: 'footer.icon.clock:clicked',
    ERROR: 'footer.icon.clock:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'clock' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--clock', svg: 'dsd-icon__svg' }
};
