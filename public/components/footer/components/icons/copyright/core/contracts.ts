...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-copyright-contracts
// PURPOSE: copyright Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-copyright-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.copyright:mounted',
    UNMOUNTED: 'footer.icon.copyright:unmounted',
    RENDERED: 'footer.icon.copyright:rendered',
    CLICKED: 'footer.icon.copyright:clicked',
    ERROR: 'footer.icon.copyright:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'copyright' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--copyright', svg: 'dsd-icon__svg' }
};
