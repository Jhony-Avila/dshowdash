...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-copyright
// PURPOSE: copyright Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-copyright';
...
function _log(level: string, ...args: unknown[]) {
  if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') {
    ...
    (Logger as Record<string,unknown>)[level as string]('[COPYRIGHT]', ...args);
  }
}
...
if (typeof window !== 'undefined') {
  ...
  window.__dev.footerIconCopyright = { getVersion: () => VERSION, info: () => CopyrightIcon.info(), healthCheck: () => CopyrightIcon.healthCheck() };
}

export default CopyrightIcon;
export { CopyrightIcon, MODULE_ID, VERSION };
