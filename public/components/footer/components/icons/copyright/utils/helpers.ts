...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-copyright-helpers
// PURPOSE: copyright Icon - Helpers
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'footer-icon-copyright-helpers';
...
export const Helpers = {
  ...
  buildClasses(p: Record<string, unknown> = {}) {
    ...
    return ['dsd-icon', 'dsd-icon--copyright', `dsd-icon--${p.variant || 'primary'}`, `dsd-icon--size-${p.size || 'md'}`, `dsd-icon--state-${p.state || 'default'}`, p.clickable ? 'dsd-icon--clickable' : ''].filter(Boolean).join(' ');
  }
};
