...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-cpu-contracts
// PURPOSE: cpu Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-cpu-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.cpu:mounted',
    UNMOUNTED: 'footer.icon.cpu:unmounted',
    RENDERED: 'footer.icon.cpu:rendered',
    CLICKED: 'footer.icon.cpu:clicked',
    ERROR: 'footer.icon.cpu:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'cpu' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--cpu', svg: 'dsd-icon__svg' }
};
