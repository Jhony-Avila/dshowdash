...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconCreditCard = { getVersion: () => VERSION, info: () => CreditCardIcon.info(), healthCheck: () => CreditCardIcon.healthCheck() };
}
var credit_card_default = CreditCardIcon;
export {
  CreditCardIcon,
  MODULE_ID,
  VERSION,
