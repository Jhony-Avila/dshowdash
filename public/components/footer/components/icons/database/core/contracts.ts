...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-database-contracts
// PURPOSE: database Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-database-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.database:mounted',
    UNMOUNTED: 'footer.icon.database:unmounted',
    RENDERED: 'footer.icon.database:rendered',
    CLICKED: 'footer.icon.database:clicked',
    ERROR: 'footer.icon.database:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'database' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--database', svg: 'dsd-icon__svg' }
};
