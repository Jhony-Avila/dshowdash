...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-device-mic-controller
// PURPOSE: device-mic Icon - Controller
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-device-mic-controller';
...
export const Controller = {
  ...
  async mount(container: HTMLElement|null, props: Record<string, unknown> = {}) {
    ...
    if (v.props.clickable) {
      const el = container.querySelector('.dsd-icon--device-mic');
