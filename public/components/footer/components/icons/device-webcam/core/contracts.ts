...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-device-webcam-contracts
// PURPOSE: device-webcam Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-device-webcam-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.device-webcam:mounted',
    UNMOUNTED: 'footer.icon.device-webcam:unmounted',
    RENDERED: 'footer.icon.device-webcam:rendered',
    CLICKED: 'footer.icon.device-webcam:clicked',
    ERROR: 'footer.icon.device-webcam:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'device-webcam' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--device-webcam', svg: 'dsd-icon__svg' }
};
