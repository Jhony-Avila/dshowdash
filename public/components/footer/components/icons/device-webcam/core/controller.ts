...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-device-webcam-controller
// PURPOSE: device-webcam Icon - Controller
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-device-webcam-controller';
...
export const Controller = {
  ...
  async mount(container: HTMLElement|null, props: Record<string, unknown> = {}) {
    _metrics.mounts++;
    if (!container) { _metrics.errors++; throw new Error('Container required'); }
    ...
    if (v.props.clickable) {
      const el = container.querySelector('.dsd-icon--device-webcam');
