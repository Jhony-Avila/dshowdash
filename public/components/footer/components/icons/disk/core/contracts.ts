...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-disk-contracts
// PURPOSE: disk Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-disk-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.disk:mounted',
    UNMOUNTED: 'footer.icon.disk:unmounted',
    RENDERED: 'footer.icon.disk:rendered',
    CLICKED: 'footer.icon.disk:clicked',
    ERROR: 'footer.icon.disk:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'disk' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--disk', svg: 'dsd-icon__svg' }
};
