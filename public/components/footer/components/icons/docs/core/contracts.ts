...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-docs-contracts
// PURPOSE: docs Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-docs-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.docs:mounted',
    UNMOUNTED: 'footer.icon.docs:unmounted',
    RENDERED: 'footer.icon.docs:rendered',
    CLICKED: 'footer.icon.docs:clicked',
    ERROR: 'footer.icon.docs:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'docs' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--docs', svg: 'dsd-icon__svg' }
};
