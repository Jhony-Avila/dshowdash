...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconDollarSign = { getVersion: () => VERSION, info: () => DollarSignIcon.info(), healthCheck: () => DollarSignIcon.healthCheck() };
}
var dollar_sign_default = DollarSignIcon;
export {
  DollarSignIcon,
  MODULE_ID,
  VERSION,
