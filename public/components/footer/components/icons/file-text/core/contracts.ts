...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-file-text-contracts
// PURPOSE: file-text Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
const MODULE_ID = 'footer-icon-file-text-contracts';
const VERSION = '1.1.0-ENTERPRISE';
export const CONTRACTS = {
  EVENTS: { MOUNTED: 'footer.icon.file-text:mounted', UNMOUNTED: 'footer.icon.file-text:unmounted', RENDERED: 'footer.icon.file-text:rendered', CLICKED: 'footer.icon.file-text:clicked', ERROR: 'footer.icon.file-text:error' },
  PROPS: { size: { type: 'string', values: ['xs', 'sm', 'md', 'lg', 'xl'], default: 'md' }, variant: { type: 'string', values: ['primary', 'secondary', 'brand', 'success', 'warning', 'danger', 'muted'], default: 'primary' }, state: { type: 'string', values: ['default', 'active', 'disabled', 'loading'], default: 'default' }, decorative: { type: 'boolean', default: false }, ariaLabel: { type: 'string', default: 'file text' }, clickable: { type: 'boolean', default: false } },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--file-text', svg: 'dsd-icon__svg' }
};
