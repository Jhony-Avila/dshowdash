...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconFileText = { getVersion: () => VERSION, info: () => FileTextIcon.info(), healthCheck: () => FileTextIcon.healthCheck() };
}
var file_text_default = FileTextIcon;
export {
  FileTextIcon,
  MODULE_ID,
  VERSION,
