...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-file-contracts
// PURPOSE: file Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-file-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.file:mounted',
    UNMOUNTED: 'footer.icon.file:unmounted',
    RENDERED: 'footer.icon.file:rendered',
    CLICKED: 'footer.icon.file:clicked',
    ERROR: 'footer.icon.file:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'file' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--file', svg: 'dsd-icon__svg' }
};
