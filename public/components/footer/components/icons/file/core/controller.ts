...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-file-controller
// PURPOSE: file Icon - Controller
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-file-controller';
...
export const Controller = {
  ...
  async mount(container: HTMLElement|null, props: Record<string, unknown> = {}) {
    ...
    if (v.props.clickable) {
      const el = container.querySelector('.dsd-icon--file');
