...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-file-helpers
// PURPOSE: file Icon - Helpers
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'footer-icon-file-helpers';
...
export const Helpers = {
  ...
  buildClasses(p: Record<string, unknown> = {}) {
    ...
    return ['dsd-icon', 'dsd-icon--file', `dsd-icon--${p.variant || 'primary'}`, `dsd-icon--size-${p.size || 'md'}`, `dsd-icon--state-${p.state || 'default'}`, p.clickable ? 'dsd-icon--clickable' : ''].filter(Boolean).join(' ');
  }
};
