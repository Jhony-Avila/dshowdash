...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-financial-contracts
// PURPOSE: financial Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-financial-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.financial:mounted',
    UNMOUNTED: 'footer.icon.financial:unmounted',
    RENDERED: 'footer.icon.financial:rendered',
    CLICKED: 'footer.icon.financial:clicked',
    ERROR: 'footer.icon.financial:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'financial' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--financial', svg: 'dsd-icon__svg' }
};
