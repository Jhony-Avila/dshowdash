...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconFinancial = { getVersion: () => VERSION, info: () => FinancialIcon.info(), healthCheck: () => FinancialIcon.healthCheck() };
}
var financial_default = FinancialIcon;
export {
  FinancialIcon,
  MODULE_ID,
  VERSION,
  financial_default as default
};
