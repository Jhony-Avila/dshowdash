...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-globe-contracts
// PURPOSE: globe Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-globe-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.globe:mounted',
    UNMOUNTED: 'footer.icon.globe:unmounted',
    RENDERED: 'footer.icon.globe:rendered',
    CLICKED: 'footer.icon.globe:clicked',
    ERROR: 'footer.icon.globe:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'globe' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--globe', svg: 'dsd-icon__svg' }
};
