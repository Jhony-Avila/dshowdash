...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconHardDrive = { getVersion: () => VERSION, info: () => HardDriveIcon.info(), healthCheck: () => HardDriveIcon.healthCheck() };
}
var hard_drive_default = HardDriveIcon;
export {
  HardDriveIcon,
  MODULE_ID,
  VERSION,
