...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-map-pin-contracts
// PURPOSE: map-pin Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-map-pin-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.map-pin:mounted',
    UNMOUNTED: 'footer.icon.map-pin:unmounted',
    RENDERED: 'footer.icon.map-pin:rendered',
    CLICKED: 'footer.icon.map-pin:clicked',
    ERROR: 'footer.icon.map-pin:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'map-pin' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--map-pin', svg: 'dsd-icon__svg' }
};
