...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-memory-contracts
// PURPOSE: memory Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-memory-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.memory:mounted',
    UNMOUNTED: 'footer.icon.memory:unmounted',
    RENDERED: 'footer.icon.memory:rendered',
    CLICKED: 'footer.icon.memory:clicked',
    ERROR: 'footer.icon.memory:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'memory' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--memory', svg: 'dsd-icon__svg' }
};
