...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-pie-chart-contracts
// PURPOSE: pie-chart Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
// ═══════════════════════════════════════════════════════════════
'use strict';
const MODULE_ID = 'footer-icon-pie-chart-contracts';
const VERSION = '1.1.0-ENTERPRISE';
export const CONTRACTS = {
  EVENTS: { MOUNTED: 'footer.icon.pie-chart:mounted', UNMOUNTED: 'footer.icon.pie-chart:unmounted', RENDERED: 'footer.icon.pie-chart:rendered', CLICKED: 'footer.icon.pie-chart:clicked', ERROR: 'footer.icon.pie-chart:error' },
  PROPS: { size: { type: 'string', values: ['xs', 'sm', 'md', 'lg', 'xl'], default: 'md' }, variant: { type: 'string', values: ['primary', 'secondary', 'brand', 'success', 'warning', 'danger', 'muted'], default: 'primary' }, state: { type: 'string', values: ['default', 'active', 'disabled', 'loading'], default: 'default' }, decorative: { type: 'boolean', default: false }, ariaLabel: { type: 'string', default: 'pie-chart' }, clickable: { type: 'boolean', default: false } },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--pie-chart', svg: 'dsd-icon__svg' }
};
