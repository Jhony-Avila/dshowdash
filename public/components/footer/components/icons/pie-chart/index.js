...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconPieChart = { getVersion: () => VERSION, info: () => PieChartIcon.info(), healthCheck: () => PieChartIcon.healthCheck() };
}
var pie_chart_default = PieChartIcon;
export {
  MODULE_ID,
  PieChartIcon,
  VERSION,
