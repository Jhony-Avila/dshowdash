...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-pipedrive-contracts
// PURPOSE: pipedrive Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-pipedrive-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.pipedrive:mounted',
    UNMOUNTED: 'footer.icon.pipedrive:unmounted',
    RENDERED: 'footer.icon.pipedrive:rendered',
    CLICKED: 'footer.icon.pipedrive:clicked',
    ERROR: 'footer.icon.pipedrive:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'pipedrive' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--pipedrive', svg: 'dsd-icon__svg' }
};
