...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-server-contracts
// PURPOSE: server Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-server-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.server:mounted',
    UNMOUNTED: 'footer.icon.server:unmounted',
    RENDERED: 'footer.icon.server:rendered',
    CLICKED: 'footer.icon.server:clicked',
    ERROR: 'footer.icon.server:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'server' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--server', svg: 'dsd-icon__svg' }
};
