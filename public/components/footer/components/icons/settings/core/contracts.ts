...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-settings-contracts
// PURPOSE: settings Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-settings-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.settings:mounted',
    UNMOUNTED: 'footer.icon.settings:unmounted',
    RENDERED: 'footer.icon.settings:rendered',
    CLICKED: 'footer.icon.settings:clicked',
    ERROR: 'footer.icon.settings:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'settings' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--settings', svg: 'dsd-icon__svg' }
};
