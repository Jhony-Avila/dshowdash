...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-settings-controller
// PURPOSE: settings Icon - Controller
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-settings-controller';
...
export const Controller = {
  ...
  async mount(container: HTMLElement|null, props: Record<string, unknown> = {}) {
    ...
    if (v.props.clickable) {
      const el = container.querySelector('.dsd-icon--settings');
