...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-settings
// PURPOSE: settings Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-settings';
...
function _log(level: string, ...args: unknown[]) {
  if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') {
    ...
    (Logger as Record<string,unknown>)[level as string]('[SETTINGS]', ...args);
  }
}
...
if (typeof window !== 'undefined') {
  ...
  window.__dev.footerIconSettings = { getVersion: () => VERSION, info: () => SettingsIcon.info(), healthCheck: () => SettingsIcon.healthCheck() };
}

export default SettingsIcon;
export { SettingsIcon, MODULE_ID, VERSION };
