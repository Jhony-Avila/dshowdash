...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-shield-contracts
// PURPOSE: shield Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-shield-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.shield:mounted',
    UNMOUNTED: 'footer.icon.shield:unmounted',
    RENDERED: 'footer.icon.shield:rendered',
    CLICKED: 'footer.icon.shield:clicked',
    ERROR: 'footer.icon.shield:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'shield' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--shield', svg: 'dsd-icon__svg' }
};
