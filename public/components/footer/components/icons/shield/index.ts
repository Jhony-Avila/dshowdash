...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-shield
// PURPOSE: shield Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-shield';
...
function _log(level: string, ...args: unknown[]) {
  if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') {
    ...
    (Logger as Record<string,unknown>)[level as string]('[SHIELD]', ...args);
  }
}
...
if (typeof window !== 'undefined') {
  ...
  window.__dev.footerIconShield = { getVersion: () => VERSION, info: () => ShieldIcon.info(), healthCheck: () => ShieldIcon.healthCheck() };
}

export default ShieldIcon;
export { ShieldIcon, MODULE_ID, VERSION };
