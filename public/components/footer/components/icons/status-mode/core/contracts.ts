...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-status-mode-contracts
// PURPOSE: status-mode Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-status-mode-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.status-mode:mounted',
    UNMOUNTED: 'footer.icon.status-mode:unmounted',
    RENDERED: 'footer.icon.status-mode:rendered',
    CLICKED: 'footer.icon.status-mode:clicked',
    ERROR: 'footer.icon.status-mode:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'status-mode' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--status-mode', svg: 'dsd-icon__svg' }
};
