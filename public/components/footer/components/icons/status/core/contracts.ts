...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-status-contracts
// PURPOSE: status Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-status-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.status:mounted',
    UNMOUNTED: 'footer.icon.status:unmounted',
    RENDERED: 'footer.icon.status:rendered',
    CLICKED: 'footer.icon.status:clicked',
    ERROR: 'footer.icon.status:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'status' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--status', svg: 'dsd-icon__svg' }
};
