...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-support-contracts
// PURPOSE: support Icon - Contracts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
const MODULE_ID = 'footer-icon-support-contracts';
const VERSION = '1.1.0-ENTERPRISE';

export const CONTRACTS = {
  EVENTS: {
    MOUNTED: 'footer.icon.support:mounted',
    UNMOUNTED: 'footer.icon.support:unmounted',
    RENDERED: 'footer.icon.support:rendered',
    CLICKED: 'footer.icon.support:clicked',
    ERROR: 'footer.icon.support:error'
  },
  PROPS: {
    ...
    ariaLabel: { type: 'string', default: 'support' },
    clickable: { type: 'boolean', default: false }
  },
  SIZES: { xs: 12, sm: 14, md: 16, lg: 20, xl: 24 },
  CSS_CLASSES: { wrapper: 'dsd-icon dsd-icon--support', svg: 'dsd-icon__svg' }
};
