...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-support
// PURPOSE: support Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'footer-icon-support';
...
function _log(level: string, ...args: unknown[]) {
  if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') {
    ...
    (Logger as Record<string,unknown>)[level as string]('[SUPPORT]', ...args);
  }
}
...
if (typeof window !== 'undefined') {
  ...
  window.__dev.footerIconSupport = { getVersion: () => VERSION, info: () => SupportIcon.info(), healthCheck: () => SupportIcon.healthCheck() };
}

export default SupportIcon;
export { SupportIcon, MODULE_ID, VERSION };
