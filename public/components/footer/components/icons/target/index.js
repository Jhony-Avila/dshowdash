...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconTarget = { getVersion: () => VERSION, info: () => TargetIcon.info(), healthCheck: () => TargetIcon.healthCheck() };
}
var target_default = TargetIcon;
export {
  MODULE_ID,
  TargetIcon,
  VERSION,
