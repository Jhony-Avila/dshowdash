...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer-icon-terminal
// PURPOSE: terminal Icon - Entry Point
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
function _log(level: string, ...args: unknown[]) { if (Logger && typeof (Logger as Record<string,unknown>)[level as string] === 'function') { (Logger as Record<string,unknown>)[level as string]('[TERMINAL]', ...args); } }
const TerminalIcon = {
...
if (typeof window !== 'undefined') { window.__dev = window.__dev || {}; window.__dev.footerIconTerminal = { getVersion: () => VERSION, info: () => TerminalIcon.info(), healthCheck: () => TerminalIcon.healthCheck() }; }
export default TerminalIcon;
export { TerminalIcon, MODULE_ID, VERSION };
