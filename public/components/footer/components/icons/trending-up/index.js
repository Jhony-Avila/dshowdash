...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconTrendingUp = { getVersion: () => VERSION, info: () => TrendingUpIcon.info(), healthCheck: () => TrendingUpIcon.healthCheck() };
}
var trending_up_default = TrendingUpIcon;
export {
  MODULE_ID,
  TrendingUpIcon,
  VERSION,
