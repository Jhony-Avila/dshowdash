...
if (typeof window !== "undefined") {
  ...
  window.__dev.footerIconUnlock = { getVersion: () => VERSION, info: () => UnlockIcon.info(), healthCheck: () => UnlockIcon.healthCheck() };
}
var unlock_default = UnlockIcon;
export {
  MODULE_ID,
  UnlockIcon,
  VERSION,
