...
ProgressCircle.prototype.mount = function(container, initialValue) {
...
ProgressCircle.prototype._getColor = function(value) {
...
ProgressCircle.prototype.setValue = function(value) {
  ...
  if (this._progressBar) {
    ...
    this._progressBar.style.stroke = color;
  }
  if (this._valueEl) {
    this._valueEl.textContent = `${Math.round(clampedValue)}%`;
    this._valueEl.style.color = color;
  }
  return this;
};
ProgressCircle.prototype.getValue = function() {
  return this._value;
};
...
function createProgressCircle(config) {
  return new ProgressCircle(config);
}
