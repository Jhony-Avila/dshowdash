...
// ═══════════════════════════════════════════════════════════════
// MODULE: components.footer.status-devices.api.fetch
// PURPOSE: Footer - Status Devices API Fetch
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   fetchDeviceConfig() — exported function
...
function fetchDeviceConfig() { _metrics.fetches++; return Promise.resolve({ ok: true, config: { monitoredDevices: ['camera', 'microphone'], checkInterval: 30000 } }); }
...
export { MODULE_ID, VERSION, init, fetchDeviceConfig, healthCheck, info };
function destroy() { }

export default { MODULE_ID, VERSION, init, fetchDeviceConfig, healthCheck, info, injectPorts, getPorts , destroy };
