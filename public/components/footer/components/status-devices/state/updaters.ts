...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/status-devices/state/updaters
// PURPOSE: Status Devices - State Updaters (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'footer/components/status-devices/state/updaters';
...
export class StateUpdaters {
  ...
  // @ts-expect-error TS migration - TS2698
  static setWebcamActive(currentState: string, active: boolean) { return { ...currentState, webcamActive: active, lastUpdate: Date.now() }; }
  // @ts-expect-error TS migration - TS2698
  static setMicActive(currentState: string, active: boolean) { return { ...currentState, micActive: active, lastUpdate: Date.now() }; }
