...
// ═══════════════════════════════════════════════════════════════
// MODULE: footer/components/status-devices/state/validators
// PURPOSE: Status Devices - State Validators (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'footer/components/status-devices/state/validators';
...
export class StateValidators {
  ...
  static validateDeviceStatus(status: string) { if (typeof status !== 'boolean') throw new Error('Invalid device status'); return true; }
