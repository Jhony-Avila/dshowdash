...
var icon_config_default = { MODULE_ID, VERSION, init, render, setConfig, healthCheck, info, injectPorts, getPorts };
export {
  MODULE_ID,
  VERSION,
  icon_config_default as default,
  getPorts,
  healthCheck,
  info,
  init,
