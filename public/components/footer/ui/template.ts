// ═══════════════════════════════════════════════════════════════
// DEPENDENCY CONTRACT (17.1.0-UARPS-INTEGRATION)
// ═══════════════════════════════════════════════════════════════
// MODULE: footer.template
// PURPOSE: Footer Template - Enterprise V4
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   SLOTS — exported value
//   getFooterTemplate() — exported function
//   getVersion() — exported function
//   setDebug() — exported function
//   getMetrics() — exported function
//   resetMetrics() — exported function
//   getSlots() — exported function
