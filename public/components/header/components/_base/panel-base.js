const MODULE_ID = "header.components._base.panel-base";
...
function createPanelPorts(moduleId) {
...
function createEmitter(ports, moduleId) {
  return (event, data) => {
    data = data || {};
...
function PanelBase(config, options) {
  options = options || {};
  this._config = {
    id: config.id,
    label: config.label,
...
PanelBase.prototype.mount = function(container) {
  const self = this;
...
PanelBase.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelBase.prototype.isMounted = function() {
  return this._isMounted;
};
PanelBase.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelBase.prototype.getElement = function() {
  return this.element;
};
PanelBase.prototype.getConfig = function() {
  return Object.assign({}, this._config);
};
PanelBase.prototype.injectPorts = function(p) {
  return this._ports.inject(p);
};
PanelBase.prototype.getPorts = function() {
  return this._ports.snapshot();
};
function createPanelClass(config) {
  const panelConfig = {
    id: config.id,
    label: config.label,
    route: config.route,
