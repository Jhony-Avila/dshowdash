...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/email-integration/accessibility/announce
// PURPOSE: Screen reader announcer for accessibility
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   getAnnouncerRoot from ../../../utils/overlay-root.js
// PROVIDES:
//   ScreenReaderAnnouncer() — screen reader announcement constructor
//   setDebug(enabled) — toggle debug mode
//   getLogs() — retrieve log buffer
//   ScreenReaderAnnouncer (default) — default export
// ═══════════════════════════════════════════════════════════════
// Email Integration - Screen Reader Announcer (Enterprise)
// @version 5.2.0-ES6
...
export const MODULE_ID = 'header/components/email-integration/accessibility/announce';
let _debug = false;
