...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/email-integration/api/alerts
// PURPOSE: Alerts API for email notifications
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   FetchAdapter from ./fetch.js
// PROVIDES:
//   AlertsAPI — email alert retrieval class
//   setDebug(enabled) — toggle debug mode
//   getLogs() — retrieve log buffer
//   AlertsAPI (default) — default export
// ═══════════════════════════════════════════════════════════════
// Email Integration - Alerts API (Enterprise)
// @version 5.1.0-ENTERPRISE
// @changelog v5.1.0 - Removed console.* for enterprise compliance
'use strict';

export const VERSION = '5.1.0-ENTERPRISE';
export const MODULE_ID = 'header/components/email-integration/api/alerts';
...
export class AlertsAPI {
  ...
  async getAlerts() {
    ...
    try { const response = await this.fetch.get('/alerts/list.php'); this._metrics.successCount++; return { ok: response.ok || false, alerts: response.alerts || [] }; }
