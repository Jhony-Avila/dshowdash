...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/email-integration/ui/ripple
// PURPOSE: Material-style ripple effect for click feedback
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   create(event, element) — create ripple at click position
//   attach(element) — attach click handler for ripple
//   detach(element) — remove click handler
//   cleanup() — remove leaked ripple DOM elements
//   destroy() — full cleanup and reset metrics
//   getMetrics() — retrieve ripple metrics
//   healthCheck() — ripple health status
//   info() — module info
//   default { create, attach, detach, cleanup, destroy, ... }
// ═══════════════════════════════════════════════════════════════
// Header Email Integration - Ripple Effect
...
export const MODULE_ID = 'header/components/email-integration/ui/ripple';
