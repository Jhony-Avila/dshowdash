...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/errors-status/utils/formatters
// PURPOSE: Errors Status - Formatters (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'header/components/errors-status/utils/formatters';
...
export class Formatters { [key: string]: any;
  static formatErrorCount(count: number) {
    if (count === null || count === undefined) return '--';
    if (count === 0) return '✓';
    return count > 99 ? '99+' : String(count);
  }
  static formatTimestamp(ts: unknown) {
    if (!ts) return '--';
