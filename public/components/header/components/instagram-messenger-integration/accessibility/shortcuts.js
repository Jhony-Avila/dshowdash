...
const MODULE_ID = "header/components/instagram-messenger-integration/accessibility/shortcuts";
let _debug = false;
let _logBuffer = [];
...
class KeyboardShortcuts {
  ...
  info() {
    return { version: VERSION, moduleId: MODULE_ID, shortcutCount: this.shortcuts.size, enabled: this.enabled, metrics: this._metrics, healthCheck: this.healthCheck() };
  }
  setDebug(enabled) {
    this._debug = !!enabled;
    _debug = !!enabled;
