...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.instagram-messenger-integration.telemetry.logger
// PURPOSE: Enterprise logger with Ports integration for Instagram telemetry
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'header.instagram-messenger-integration.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[instagram-messenger]'; this.debug = options.debug || false; }
