...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.notifications.telemetry.logger
...
export const MODULE_ID = 'header.notifications.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[notifications]'; this.debug = options.debug || false; }
