...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/notifications/utils/helpers
// PURPOSE: Notifications - Helper Utilities (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'header/components/notifications/utils/helpers';
...
export class Helpers { [key: string]: any;
  static generateId(prefix = 'notif') { return `${prefix}-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`; }
  static healthCheck() {
