...
// ═════════════════════════════════════════════════════════════
// MODULE: header/components/panel-adwords/accessibility/announce
// PURPOSE: Screen Reader Announcer
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   getAnnouncerRoot from ../../../utils/overlay-root.js
// PROVIDES:
//   ScreenReaderAnnouncer (class)
//   default: ScreenReaderAnnouncer
// ═════════════════════════════════════════════════════════════
// panel-adwords - Screen Reader Announcer (Enterprise)
...
export const MODULE_ID = 'header/components/panel-adwords/accessibility/announce';
