...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-adwords/component.css";
...
function PanelAdwordsComponent(options) {
  options = options || {};
...
PanelAdwordsComponent.prototype.mount = function(container) {
...
PanelAdwordsComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-adwords-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-adwords");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelAdwordsComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelAdwordsComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelAdwordsComponent.prototype.unmount = function() {
...
PanelAdwordsComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelAdwordsComponent.prototype.healthCheck = function() {
...
PanelAdwordsComponent.prototype.info = function() {
...
PanelAdwordsComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelAdwordsComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelAdwordsComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelAdwordsComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelAdwordsComponent(options);
}
var panel_adwords_default = PanelAdwordsComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_adwords_default as default,
  getPorts,
  id,
  injectPorts
};
