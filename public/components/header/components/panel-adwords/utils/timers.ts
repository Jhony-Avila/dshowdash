...
// ═════════════════════════════════════════════════════════════
// MODULE: header/components/panel-adwords/utils/timers
// PURPOSE: Timers Manager
// ─────────────────────────────────────────────────────────────
// PROVIDES:
//   setTimeout()
//   clearTimeout()
...
//   resetMetrics()
// ═════════════════════════════════════════════════════════════
// panel-adwords - Timers Manager (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-adwords/utils/timers';
