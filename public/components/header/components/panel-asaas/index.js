...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-asaas/component.css";
...
function PanelAsaasComponent(options) {
  options = options || {};
...
PanelAsaasComponent.prototype.mount = function(container) {
...
PanelAsaasComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-asaas-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-asaas");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelAsaasComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelAsaasComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelAsaasComponent.prototype.unmount = function() {
...
PanelAsaasComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelAsaasComponent.prototype.healthCheck = function() {
...
PanelAsaasComponent.prototype.info = function() {
...
PanelAsaasComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelAsaasComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelAsaasComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelAsaasComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelAsaasComponent(options);
}
var panel_asaas_default = PanelAsaasComponent;
export {
  MODULE_ID,
  PanelAsaasComponent,
  VERSION,
  capabilities,
  createComponent,
  panel_asaas_default as default,
  getPorts,
  id,
  injectPorts
};
