...
// ═════════════════════════════════════════════════════════════
// MODULE: header.panel-asaas.telemetry.logger
...
export const MODULE_ID = 'header.panel-asaas.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-asaas]'; this.debug = options.debug || false; }
