...
// ═════════════════════════════════════════════════════════════
// MODULE: header/components/panel-asaas/utils/formatters
// PURPOSE: Formatters
// ─────────────────────────────────────────────────────────────
// PROVIDES:
//   formatCurrency()
...
//   slugify()
// ═════════════════════════════════════════════════════════════
// panel-asaas - Formatters (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-asaas/utils/formatters';
