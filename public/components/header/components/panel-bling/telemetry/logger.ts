...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.panel-bling.telemetry.logger
...
export const MODULE_ID = 'header.panel-bling.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-bling]'; this.debug = options.debug || false; }
