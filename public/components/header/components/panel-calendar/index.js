...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-calendar/component.css";
...
function PanelCalendarComponent(options) {
  options = options || {};
...
PanelCalendarComponent.prototype.mount = function(container) {
...
PanelCalendarComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-calendar-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-calendar");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelCalendarComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelCalendarComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelCalendarComponent.prototype.unmount = function() {
...
PanelCalendarComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelCalendarComponent.prototype.healthCheck = function() {
...
PanelCalendarComponent.prototype.info = function() {
...
PanelCalendarComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelCalendarComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelCalendarComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelCalendarComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelCalendarComponent(options);
}
var panel_calendar_default = PanelCalendarComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_calendar_default as default,
  getPorts,
  id,
  injectPorts
};
