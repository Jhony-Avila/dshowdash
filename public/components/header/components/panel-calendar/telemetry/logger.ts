...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.panel-calendar.telemetry.logger
...
export const MODULE_ID = 'header.panel-calendar.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-calendar]'; this.debug = options.debug || false; }
