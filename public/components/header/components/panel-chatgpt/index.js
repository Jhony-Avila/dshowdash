...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-chatgpt/component.css";
...
function PanelChatgptComponent(options) {
  options = options || {};
...
PanelChatgptComponent.prototype.mount = function(container) {
...
PanelChatgptComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-chatgpt-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-chatgpt");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelChatgptComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelChatgptComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelChatgptComponent.prototype.unmount = function() {
...
PanelChatgptComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelChatgptComponent.prototype.healthCheck = function() {
...
PanelChatgptComponent.prototype.info = function() {
...
PanelChatgptComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelChatgptComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelChatgptComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelChatgptComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelChatgptComponent(options);
}
var panel_chatgpt_default = PanelChatgptComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_chatgpt_default as default,
  getPorts,
  id,
  injectPorts
};
