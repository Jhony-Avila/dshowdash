...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.panel-chatgpt.telemetry.logger
...
export const MODULE_ID = 'header.panel-chatgpt.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-chatgpt]'; this.debug = options.debug || false; }
