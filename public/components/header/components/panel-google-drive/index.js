...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-google-drive/component.css";
...
function PanelGoogleDriveComponent(options) {
  options = options || {};
...
PanelGoogleDriveComponent.prototype.mount = function(container) {
...
PanelGoogleDriveComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-google-drive-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-google-drive");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelGoogleDriveComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelGoogleDriveComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelGoogleDriveComponent.prototype.unmount = function() {
...
PanelGoogleDriveComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelGoogleDriveComponent.prototype.healthCheck = function() {
...
PanelGoogleDriveComponent.prototype.info = function() {
...
PanelGoogleDriveComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelGoogleDriveComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelGoogleDriveComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelGoogleDriveComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelGoogleDriveComponent(options);
}
var panel_google_drive_default = PanelGoogleDriveComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_google_drive_default as default,
  getPorts,
  id,
  injectPorts
};
