...
// ═══════════════════════════════════════════════════════════════
// MODULE: header-panel-loja-integrada-core-lifecycle
// PURPOSE: Component lifecycle management (mount/unmount)
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   LifecycleManager — class with mount(), unmount(), getState(), healthCheck()
...
export const MODULE_ID = 'header-panel-loja-integrada-core-lifecycle';
