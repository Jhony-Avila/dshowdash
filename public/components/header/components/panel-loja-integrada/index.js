...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-loja-integrada/component.css";
...
function PanelLojaIntegradaComponent(options) {
  options = options || {};
...
PanelLojaIntegradaComponent.prototype.mount = function(container) {
...
PanelLojaIntegradaComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-loja-integrada-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-loja-integrada");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelLojaIntegradaComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelLojaIntegradaComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelLojaIntegradaComponent.prototype.unmount = function() {
...
PanelLojaIntegradaComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelLojaIntegradaComponent.prototype.healthCheck = function() {
...
PanelLojaIntegradaComponent.prototype.info = function() {
...
PanelLojaIntegradaComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelLojaIntegradaComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelLojaIntegradaComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelLojaIntegradaComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelLojaIntegradaComponent(options);
}
var panel_loja_integrada_default = PanelLojaIntegradaComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_loja_integrada_default as default,
  getPorts,
  id,
  injectPorts
};
