const MODULE_ID = "header-panel-loja-integrada-state-store";
...
function healthCheck() {
  return { status: _state?._initialized !== false ? "HEALTHY" : "DEGRADED", version: VERSION, moduleId: MODULE_ID, checks: { storeReady: true } };
}
export {
  MODULE_ID,
  StateStore,
