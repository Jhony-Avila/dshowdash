...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-loja-integrada/state/updaters
// PURPOSE: Immutable state update helper functions
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   updateField(state, field, value) — update single field
//   updateMultiple(state, updates) — update multiple fields
//   toggleField(state, field) — toggle boolean field
//   incrementField(state, field, amount) — increment numeric field
//   pushToArray(state, field, item) — append item to array field
//   removeFromArray(state, field, predicate) — remove items from array
//   healthCheck() — module health status
//   info() — module information
// ═══════════════════════════════════════════════════════════════
// panel-loja-integrada - State Updaters (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-loja-integrada/state/updaters';
