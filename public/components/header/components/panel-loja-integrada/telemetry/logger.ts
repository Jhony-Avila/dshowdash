...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.panel-loja-integrada.telemetry.logger
...
// ═══════════════════════════════════════════════════════════════
// Panel Loja Integrada - Logger (Enterprise)
// @version 8.4.0-ES6
// @changelog v8.4.0-ES6 - Task 10.1 B01: var → const/let
'use strict';
import { createUiPorts } from '/core/runtime/ports-profiles.js';
export const MODULE_ID = 'header.panel-loja-integrada.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-loja-integrada]'; this.debug = options.debug || false; }
