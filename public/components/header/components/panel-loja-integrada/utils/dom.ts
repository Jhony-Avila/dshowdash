...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-loja-integrada/utils/dom
// PURPOSE: DOM utility functions (query, create, manipulate)
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   $(selector, context) — querySelector shorthand
//   $$(selector, context) — querySelectorAll shorthand
//   createElement(tag, attrs, children) — create DOM element
//   removeElement/emptyElement(el) — remove or empty elements
//   addClass/removeClass/toggleClass/hasClass(el, cls) — class helpers
//   setAttr/getAttr/removeAttr(el, name, value) — attribute helpers
//   healthCheck() — module health status
// ═══════════════════════════════════════════════════════════════
// panel-loja-integrada - DOM Utilities (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-loja-integrada/utils/dom';
