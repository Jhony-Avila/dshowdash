...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-loja-integrada/utils/helpers
// PURPOSE: General utility functions (debounce, throttle, deep operations)
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   debounce(fn, delay) — debounce function calls
//   throttle(fn, limit) — throttle function calls
//   deepClone/deepMerge(obj) — deep object operations
//   isObject/isEmpty(val) — type checking utilities
...
// ═══════════════════════════════════════════════════════════════
// panel-loja-integrada - Helpers (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-loja-integrada/utils/helpers';
