...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-loja-integrada/utils/timers
// PURPOSE: Managed timers and intervals with leak prevention
// ───────────────────────────────────────────────────────────────
// PROVIDES:
//   setTimeout(fn, delay, id) — managed setTimeout via window.setTimeout
//   clearTimeout(id) — clear managed timeout
//   setInterval(fn, delay, id) — managed setInterval via window.setInterval
//   clearInterval(id) — clear managed interval
//   clearAll() — clear all managed timers and intervals
//   getActiveCount() — count of active timers/intervals
//   healthCheck() — module health status
//   info() — module information
// ═══════════════════════════════════════════════════════════════
// panel-loja-integrada - Timers Manager (Enterprise)
// @version 8.1.0-ENTERPRISE
'use strict';

import { VERSION } from '/core/version.js'; export { VERSION };
export const MODULE_ID = 'header/components/panel-loja-integrada/utils/timers';
