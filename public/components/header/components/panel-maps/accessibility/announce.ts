...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-maps/accessibility/announce
...
// ═══════════════════════════════════════════════════════════════
// panel-maps - Screen Reader Announcer (Enterprise)
...
export const MODULE_ID = 'header/components/panel-maps/accessibility/announce';
