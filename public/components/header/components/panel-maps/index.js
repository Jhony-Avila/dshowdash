...
const MODULE_ID = "header/components/panel-maps";
...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-maps/component.css";
...
function PanelMapsComponent(options) {
  options = options || {};
...
PanelMapsComponent.prototype.mount = function(container) {
...
PanelMapsComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-maps-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-maps");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelMapsComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelMapsComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelMapsComponent.prototype.unmount = function() {
...
PanelMapsComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelMapsComponent.prototype.healthCheck = function() {
...
PanelMapsComponent.prototype.info = function() {
...
PanelMapsComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelMapsComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelMapsComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelMapsComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelMapsComponent(options);
}
var panel_maps_default = PanelMapsComponent;
export {
  MODULE_ID,
  PanelMapsComponent,
  VERSION,
