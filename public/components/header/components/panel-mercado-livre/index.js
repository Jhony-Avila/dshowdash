...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-mercado-livre/component.css";
...
function PanelMercadoLivreComponent(options) {
  options = options || {};
...
PanelMercadoLivreComponent.prototype.mount = function(container) {
...
PanelMercadoLivreComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-mercado-livre-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-mercado-livre");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelMercadoLivreComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelMercadoLivreComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelMercadoLivreComponent.prototype.unmount = function() {
...
PanelMercadoLivreComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelMercadoLivreComponent.prototype.healthCheck = function() {
...
PanelMercadoLivreComponent.prototype.info = function() {
...
PanelMercadoLivreComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelMercadoLivreComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelMercadoLivreComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelMercadoLivreComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelMercadoLivreComponent(options);
}
var panel_mercado_livre_default = PanelMercadoLivreComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_mercado_livre_default as default,
  getPorts,
  id,
  injectPorts
};
