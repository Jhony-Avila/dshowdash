...
// ═══════════════════════════════════════════════════════════════
// MODULE: header/components/panel-mercado-livre/state/validators
// PURPOSE: panel-mercado-livre - State Validators (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   isRequired() — exported function
//   isString() — exported function
//   isNumber() — exported function
//   isBoolean() — exported function
//   isArray() — exported function
//   isObject() — exported function
//   minLength() — exported function
//   maxLength() — exported function
//   inRange() — exported function
//   matches() — exported function
//   isEmail() — exported function
//   isUrl() — exported function
...
export const MODULE_ID = 'header/components/panel-mercado-livre/state/validators';
