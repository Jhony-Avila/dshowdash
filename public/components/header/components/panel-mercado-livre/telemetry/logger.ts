...
// ═══════════════════════════════════════════════════════════════
// MODULE: header.panel-mercado-livre.telemetry.logger
// PURPOSE: Panel Mercado Livre - Logger (Enterprise)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'header.panel-mercado-livre.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[panel-mercado-livre]'; this.debug = options.debug || false; }
