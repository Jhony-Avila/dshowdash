...
(function loadCSS() {
  const cssPath = "/components/header/components/panel-pipedrive/component.css";
...
function PanelPipedriveComponent(options) {
  options = options || {};
...
PanelPipedriveComponent.prototype.mount = function(container) {
...
PanelPipedriveComponent.prototype._render = function() {
  this.element = document.createElement("button");
  this.element.type = "button";
  this.element.className = "header-panel-trigger panel-pipedrive-trigger";
  ...
  this.element.setAttribute("data-uarps-trigger", "trigger:header:open-panel-pipedrive");
  this.element.innerHTML = `<img src="${PANEL_CONFIG.icon}" alt="${PANEL_CONFIG.label}" class="trigger-icon" loading="lazy" />`;
  this.container.appendChild(this.element);
};
PanelPipedriveComponent.prototype._attachEvents = function() {
  const self = this;
...
PanelPipedriveComponent.prototype._detachEvents = function() {
  if (this.element && this._clickHandler) {
    this.element.removeEventListener("click", this._clickHandler);
    this._clickHandler = null;
  }
};
PanelPipedriveComponent.prototype.unmount = function() {
...
PanelPipedriveComponent.prototype.destroy = function() {
  if (this._isDestroyed) return;
  this.unmount();
  this._isDestroyed = true;
  this.container = null;
};
PanelPipedriveComponent.prototype.healthCheck = function() {
...
PanelPipedriveComponent.prototype.info = function() {
...
PanelPipedriveComponent.prototype.getMetrics = function() {
  return Object.assign({}, this._metrics);
};
PanelPipedriveComponent.prototype.isMounted = function() {
  return this._isMounted;
};
PanelPipedriveComponent.prototype.isDestroyed = function() {
  return this._isDestroyed;
};
PanelPipedriveComponent.prototype.getElement = function() {
  return this.element;
};
function createComponent(options) {
  return new PanelPipedriveComponent(options);
}
var panel_pipedrive_default = PanelPipedriveComponent;
export {
  MODULE_ID,
  ...
  capabilities,
  createComponent,
  panel_pipedrive_default as default,
  getPorts,
  id,
  injectPorts
};
