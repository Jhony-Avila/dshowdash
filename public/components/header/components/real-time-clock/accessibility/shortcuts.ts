...
// =============================================================
// MODULE: header/components/real-time-clock/accessibility/shortcuts
// PURPOSE: Keyboard shortcuts registration and handling for clock
// -------------------------------------------------------------
// PROVIDES:
...
//   getLogs()
// =============================================================
// Real Time Clock - Keyboard Shortcuts (Enterprise)
// @version 5.1.0-ENTERPRISE
// @changelog v5.1.0 - Removed console.* for enterprise compliance
'use strict';

export const VERSION = '5.1.0-ENTERPRISE';
export const MODULE_ID = 'header/components/real-time-clock/accessibility/shortcuts';
