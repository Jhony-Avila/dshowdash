...
const emitUIAction = (data = {}) => {
  ...
  eventBus.emit(UI_EVENTS.ACTION, { actionId: "header:whatsapp-integration", source: MODULE_ID, timestamp: Date.now(), meta: Object.assign({ kind: "ui" }, data) });
};
(function loadCSS() {
  const cssPath = "/components/header/components/whatsapp-integration/component.css";
...
WhatsAppIntegrationComponent.prototype.updateUI = function(state) {
...
WhatsAppIntegrationComponent.prototype.info = function() {
...
var whatsapp_integration_default = WhatsAppIntegrationComponent;
export {
  MODULE_ID,
  VERSION,
  WhatsAppIntegrationComponent,
  capabilities,
  whatsapp_integration_default as default,
  getPorts,
  id,
  injectPorts
};
