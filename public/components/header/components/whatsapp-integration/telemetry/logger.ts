// ═══════════════════════════════════════════════════════════════
// DEPENDENCY CONTRACT (2.3.0-AAA)
// ═══════════════════════════════════════════════════════════════
// MODULE: header.whatsapp-integration.telemetry.logger
...
export const MODULE_ID = 'header.whatsapp-integration.telemetry.logger';
...
function Logger(this: any, options: Record<string,unknown>) { if (!options) options = {}; this.prefix = options.prefix || '[whatsapp-integration]'; this.debug = options.debug || false; }
