const MODULE_ID = "header-icons-lucide-icons";
...
const Icons = {
  ...
  Coins: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18M7 6h1v4"/></svg>`,
  CloudRain: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M16 14v6M8 14v6M12 16v6"/></svg>`,
...
function info() {
  return { moduleId: MODULE_ID, version: VERSION, iconsCount: Object.keys(Icons).length };
}
function healthCheck() {
  return { status: "HEALTHY", version: VERSION, moduleId: MODULE_ID, checks: { iconsLoaded: Object.keys(Icons).length > 0 } };
}
var lucide_icons_default = Icons;
export {
  Icons,
  MODULE_ID,
  VERSION,
  lucide_icons_default as default,
  healthCheck,
  info
};
