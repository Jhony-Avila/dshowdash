...
const MODULE_ID = "import-controller";
class ImportController {
  ...
  async importSnapshot(data, options = {}) {
    ...
    try {
      ...
      await this._persistence.save(void 0, snapshot);
  ...
  healthCheck() {
    return { status: this._persistence ? "healthy" : "degraded", hasPersistence: !!this._persistence, hasRehydration: !!this._rehydration, metrics: { ...this._metrics }, version: VERSION, moduleId: MODULE_ID };
  }
  info() {
    return { version: VERSION, moduleId: MODULE_ID, schemaVersion: SCHEMA_VERSION, metrics: { ...this._metrics } };
  }
}
function createImportController(context) {
  return new ImportController(context);
}
var import_controller_default = { ImportController, createImportController, VERSION, MODULE_ID };
export {
  ImportController,
  MODULE_ID,
  VERSION,
  createImportController,
  import_controller_default as default
};
