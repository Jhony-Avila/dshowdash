...
// PURPOSE: Bootstrap Integration Constants
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const VERSION = '13.1.0-MODULAR';
export const MODULE_ID = 'container-main:bootstrap.bootstrap-integration.constants';
...
export default { VERSION, MODULE_ID, BOOTSTRAP_STATES, CONFIG_SCHEMA, DEFAULT_CONFIG };
