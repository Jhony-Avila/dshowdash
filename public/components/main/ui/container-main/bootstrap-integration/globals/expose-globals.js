...
function exposeGlobals(bootstrapInstance, context) {
  ...
  window.ContainerMain = {
    ...
    getContentElement() {
      return container?.querySelector?.(".dsd-container__content") || container;
    },
    getBootstrap() {
...
var expose_globals_default = {
  exposeGlobals,
  clearGlobals
};
export {
  clearGlobals,
  expose_globals_default as default,
  exposeGlobals
};
