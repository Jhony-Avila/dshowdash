...
function createEnhancements(container, options = {}) {
  const {
  ...
  return {
    ...
    getScroll() {
      return enhancements.scroll;
    },
    getValidation() {
      return enhancements.validation;
    },
    getSave() {
      return enhancements.save;
    },
    getConnection() {
      return enhancements.connection;
    },
    shake() {
      enhancements.validation?.shake();
      return this;
    },
    saving() {
      enhancements.save?.saving();
      return this;
    },
    saved() {
      enhancements.save?.saved();
      return this;
    },
    setDepth(depth) {
...
function createAllEnhancements(container, options = {}) {
  const {
    scrollIndicator = true,
    validationShake = true,
    saveIndicator = false,
  ...
  return {
    ...
    enterPiP() {
      enhancements.pip?.enter();
      return this;
    },
    exitPiP() {
      enhancements.pip?.exit();
      return this;
    },
    destroy() {
      Object.values(enhancements).forEach((e) => e?.destroy?.());
