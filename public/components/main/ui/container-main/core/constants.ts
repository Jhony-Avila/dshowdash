...
// PURPOSE: container-main/core/constants.js
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   CONTAINER_MAIN_EVENTS — exported value
//   MODULES — exported value
//   CORE_MODULES — exported value
//   FEATURES — exported value
//   UTILS — exported value
//   FEATURE_FLAGS — exported value
//   Z_INDEX — exported value
//   DURATIONS — exported value
...
export const MODULE_ID = 'container-main.core.constants';

// P4: UARPS region for permissions governance
...
// P1/P3: Events for integration
export const CONTAINER_MAIN_EVENTS = {
  // State events
...
export const FEATURES = [
  'header', 'controls', 'context-menu', 'keyboard', 'drag', 'resize',
  'tabs', 'breadcrumb', 'split-view', 'notification-badge', 'state-persistence',
  'toolbar', 'search-box', 'progress-bar', 'toast', 'snap-dock',
  'multi-window', 'zoom-controls', 'accessibility', 'usage-metrics',
  'performance-monitor', 'error-boundary', 'debug-panel',
  'plugin-system', 'event-hooks', 'config-presets', 'status-indicator', 'skeleton'
];

// Utility modules
export const UTILS = [
  'logger', 'events', 'icons', 'debounce', 'telemetry', 'async-helpers',
  'config-cache', 'weak-refs', 'idle-scheduler', 'visibility-observer',
  'dom-batch', 'mutation-batch', 'lazy-loader', 'virtual-scroller',
  'worker-pool', 'indexed-db', 'state-compression', 'object-pool',
  'reactive-proxy', 'service-worker-helper', 'custom-elements', 'error-handler',
  'theme-manager', 'layout-manager', 'animation-manager', 'shortcuts-manager'
];
...
export default {
  ...
  STATES, CONTAINER_MAIN_EVENTS,
  MODULES, CORE_MODULES, FEATURES, UTILS,
  FEATURE_FLAGS, Z_INDEX, DURATIONS, BREAKPOINTS,
  info, healthCheck
};
