...
export const MODULE_ID = 'main.ui.container-main.utils.print-manager.operations.preview';

// @ts-expect-error strict migration — TS2322
export function printPreview(element: HTMLElement = null, options: Record<string, unknown> = {}) {
