...
const VERSION = "2.2.0-ICON-REGISTRY";
const MODULE_ID = "navrail-shared-icons";
const ICONS = {
  // Navigation
  ...
  "user-cog": '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="9" cy="7" r="4"/><path d="M3 21v-2a4 4 0 0 1 4-4h4"/><circle cx="17" cy="17" r="3"/><path d="M17 14v-1m0 8v-1m3-2h1m-8 0h1m.5-2.5l.7-.7m4.6 4.6l.7-.7m-4.6 0l-.7-.7m6-.1l-.7.7"/></svg>',
  // Analytics
...
function getIcon(name) {
  ...
  return ICONS.default || '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/></svg>';
}
function hasIcon(name) {
  return !!ICONS[name];
}
function listIcons() {
  return Object.keys(ICONS).filter((k) => k !== "default");
}
var icons_default = { ICONS, getIcon, hasIcon, listIcons, VERSION, MODULE_ID };
export {
  ICONS,
  MODULE_ID,
  VERSION,
