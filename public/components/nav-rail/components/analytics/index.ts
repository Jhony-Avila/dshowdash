...
// ═════════════════════════════════════════════════════════════
// MODULE: nav-rail/analytics
// PURPOSE: NavRail Analytics button — factory-generated component
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createAnalyticsButton() — creates analytics button instance
...
//   (none)
// ═════════════════════════════════════════════════════════════
// NavRail Analytics Button Component - Factory Generated
// @version 3.2.0-AAA
...
const buttonExports = createButtonExports('analytics');
...
export const createAnalyticsButton = buttonExports.createButton;
...
export default {
  AnalyticsButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createAnalyticsButton: buttonExports.createButton,
