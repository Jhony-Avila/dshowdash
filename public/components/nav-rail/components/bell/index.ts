...
// ═════════════════════════════════════════════════════════════
// MODULE: nav-rail/bell
// PURPOSE: NavRail Bell button — factory-generated component
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createBellButton() — creates bell button instance
...
//   (none)
// ═════════════════════════════════════════════════════════════
// NavRail Bell Button Component - Factory Generated
// @version 3.2.0-AAA
...
const buttonExports = createButtonExports('bell');
...
export const createBellButton = buttonExports.createButton;
...
export default {
  BellButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createBellButton: buttonExports.createButton,
