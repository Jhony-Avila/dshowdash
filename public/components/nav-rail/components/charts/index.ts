...
// ═════════════════════════════════════════════════════════════
// MODULE: nav-rail/charts
// PURPOSE: NavRail Charts button — factory-generated component
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createChartsButton() — creates charts button instance
...
//   (none)
// ═════════════════════════════════════════════════════════════
// NavRail Charts Button Component - Factory Generated
// @version 3.2.0-AAA
...
const buttonExports = createButtonExports('charts');
...
export const createChartsButton = buttonExports.createButton;
...
export default {
  ChartsButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createChartsButton: buttonExports.createButton,
