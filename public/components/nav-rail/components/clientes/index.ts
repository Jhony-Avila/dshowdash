...
// ═════════════════════════════════════════════════════════════
// MODULE: nav-rail/clientes
// PURPOSE: NavRail Clientes button — factory-generated component
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createClientesButton() — creates clientes button instance
...
//   (none)
// ═════════════════════════════════════════════════════════════
// NavRail Clientes Button Component - Factory Generated
// @version 3.2.0-AAA
...
const buttonExports = createButtonExports('clientes');
...
export const createClientesButton = buttonExports.createButton;
...
export default {
  ClientesButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createClientesButton: buttonExports.createButton,
