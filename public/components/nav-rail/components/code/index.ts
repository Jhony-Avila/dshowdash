...
// ═════════════════════════════════════════════════════════════
// MODULE: nav-rail/code
// PURPOSE: NavRail Code button — factory-generated component
// ─────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createCodeButton() — creates code button instance
...
//   (none)
// ═════════════════════════════════════════════════════════════
// NavRail Code Button Component - Factory Generated
// @version 3.2.0-AAA
...
const buttonExports = createButtonExports('code');
...
export const createCodeButton = buttonExports.createButton;
...
export default {
  CodeButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createCodeButton: buttonExports.createButton,
