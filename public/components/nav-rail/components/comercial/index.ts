...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/comercial
// PURPOSE: NavRail Comercial button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createComercialButton() — creates comercial button instance
...
const buttonExports = createButtonExports('comercial');
...
export const createComercialButton = buttonExports.createButton;
...
export default {
  ComercialButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createComercialButton: buttonExports.createButton,
