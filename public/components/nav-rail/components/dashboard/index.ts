...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/dashboard
// PURPOSE: NavRail Dashboard button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createDashboardButton() — creates dashboard button instance
...
const buttonExports = createButtonExports('dashboard');
...
export const createDashboardButton = buttonExports.createButton;
...
export default {
  DashboardButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createDashboardButton: buttonExports.createButton,
