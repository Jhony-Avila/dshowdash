...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/database
// PURPOSE: NavRail Database button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createDatabaseButton() — creates database button instance
...
const buttonExports = createButtonExports('database');
...
export const createDatabaseButton = buttonExports.createButton;
...
export default {
  DatabaseButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createDatabaseButton: buttonExports.createButton,
