...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/financeiro
// PURPOSE: NavRail Financeiro button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createFinanceiroButton() — creates financeiro button instance
...
const buttonExports = createButtonExports('financeiro');
...
export const createFinanceiroButton = buttonExports.createButton;
...
export default {
  FinanceiroButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createFinanceiroButton: buttonExports.createButton,
