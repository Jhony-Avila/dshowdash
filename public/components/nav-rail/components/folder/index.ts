...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/folder
// PURPOSE: NavRail Folder button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createFolderButton() — creates folder button instance
...
const buttonExports = createButtonExports('folder');
...
export const createFolderButton = buttonExports.createButton;
...
export default {
  FolderButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createFolderButton: buttonExports.createButton,
