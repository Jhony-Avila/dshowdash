...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/help
// PURPOSE: NavRail Help button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createHelpButton() — creates help button instance
...
const buttonExports = createButtonExports('help');
...
export const createHelpButton = buttonExports.createButton;
...
export default {
  HelpButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createHelpButton: buttonExports.createButton,
