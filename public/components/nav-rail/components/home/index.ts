...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail-home-button
// PURPOSE: NavRail Home Button Component - Factory Generated
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createHomeButton() — creates home button instance
...
const buttonExports = createButtonExports('home');
...
export const createHomeButton = buttonExports.createButton;
...
export default {
  HomeButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createHomeButton: buttonExports.createButton,
