...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail-location-button
// PURPOSE: NavRail Location Button Component - Factory Generated
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createLocationButton() — creates location button instance
...
const buttonExports = createButtonExports('location');
...
export const createLocationButton = buttonExports.createButton;
...
export default {
  LocationButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createLocationButton: buttonExports.createButton,
