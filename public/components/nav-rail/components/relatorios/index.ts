...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail-relatorios-button
// PURPOSE: NavRail Relatorios Button Component - Factory Generated
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createRelatoriosButton() — creates relatorios button instance
...
const buttonExports = createButtonExports('relatorios');
...
export const createRelatoriosButton = buttonExports.createButton;
...
export default {
  RelatoriosButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createRelatoriosButton: buttonExports.createButton,
