...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/toggle-sidebar
// PURPOSE: NavRail ToggleSidebar button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createToggleSidebarButton() — creates toggle-sidebar button instance
...
const buttonExports = createButtonExports('toggle-sidebar');
...
export const createToggleSidebarButton = buttonExports.createButton;
...
export default {
  ToggleSidebarButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createToggleSidebarButton: buttonExports.createButton,
