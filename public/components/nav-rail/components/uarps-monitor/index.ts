...
// ═══════════════════════════════════════════════════════════════
// MODULE: nav-rail/uarps-monitor
// PURPOSE: NavRail UarpsMonitor button — factory-generated component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   createButtonExports from ../_shared/button-factory.js
// PROVIDES:
//   createUarpsMonitorButton() — creates uarps-monitor button instance
...
const buttonExports = createButtonExports('uarps-monitor');
...
export const createUarpsMonitorButton = buttonExports.createButton;
...
export default {
  UarpsMonitorButton: buttonExports.getInstance,
  getInstance: buttonExports.getInstance,
  createUarpsMonitorButton: buttonExports.createButton,
