...
const MODULE_ID = "nav-rail.core.component-mounter.retry-manager";
let _log = () => {
};
let _mountFn = null;
function setDependencies(logFn, mountFn) {
  _log = logFn;
  _mountFn = mountFn;
}
function retryComponent(id) {
