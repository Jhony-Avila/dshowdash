...
function mount(container) {
  ...
  try {
    const path = hasWindow && window.location ? window.location.pathname : "/";
    const t = _getPort("telemetry");
    if (t && t.track) t.track("page-404:mounted", { path });
  } catch (e) {
  }
...
var __default = { mount, unmount, info, healthCheck, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  MODULE_ID,
  VERSION,
