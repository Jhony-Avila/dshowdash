...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-01/ui/context-menu
// PURPOSE: Panel-01 Context Menu
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-01/ui/context-menu';
...
export class ContextMenu {
  ...
  init() {
    ...
    this.element.addEventListener('click', (e: MouseEvent) => {
      const item = (e.target as Element).closest('[data-action]') as HTMLElement | null;
  ...
  show(x: number, y: number, item: unknown) {
