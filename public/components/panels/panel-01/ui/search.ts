...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-01/ui/search
// PURPOSE: Panel-01 Search Component
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-01/ui/search';
  ...
  render() {
    ...
    this.container.innerHTML = `
      <div class="p01-search">
        ...
        <input type="text" class="p01-search-input" placeholder="Buscar requisições..." data-filter="q" autocomplete="off">
