...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-01/utils/sound-notifications
// PURPOSE: Panel-01 - Sound Notifications
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   SOUNDS — exported value
//   SoundNotificationManager() — exported function
...
export const MODULE_ID = 'panel-01/utils/sound-notifications';
...
export function SoundNotificationManager(this: any, options: Record<string, unknown> = {}) {
  options = options || {};
...
SoundNotificationManager.prototype.init = function() {
  const self = this;
  Object.keys(SOUND_DATA).forEach((key: string) => {
    self._sounds[key] = new Audio((SOUND_DATA as Record<string, string>)[key]);
    self._sounds[key].volume = self.volume;
  });
  return true;
};

SoundNotificationManager.prototype.play = function(soundType: string) {
...
SoundNotificationManager.prototype.playSuccess = function() { this.play(SOUNDS.SUCCESS); };
SoundNotificationManager.prototype.playError = function() { this.play(SOUNDS.ERROR); };
SoundNotificationManager.prototype.playWarning = function() { this.play(SOUNDS.WARNING); };
SoundNotificationManager.prototype.playInfo = function() { this.play(SOUNDS.INFO); };
SoundNotificationManager.prototype.playNewItem = function() { this.play(SOUNDS.NEW_ITEM); };
SoundNotificationManager.prototype.playMessage = function() { this.play(SOUNDS.MESSAGE); };
SoundNotificationManager.prototype.playComplete = function() { this.play(SOUNDS.COMPLETE); };

SoundNotificationManager.prototype.setVolume = function(volume: number) {
...
SoundNotificationManager.prototype.getVolume = function() { return this.volume; };
SoundNotificationManager.prototype.mute = function() { this._muted = true; this._saveSettings(); };
SoundNotificationManager.prototype.unmute = function() { this._muted = false; this._saveSettings(); };
SoundNotificationManager.prototype.toggleMute = function() { this._muted = !this._muted; this._saveSettings(); return this._muted; };
SoundNotificationManager.prototype.isMuted = function() { return this._muted; };
SoundNotificationManager.prototype.enable = function() { this.enabled = true; this._saveSettings(); };
SoundNotificationManager.prototype.disable = function() { this.enabled = false; this._saveSettings(); };
SoundNotificationManager.prototype.isEnabled = function() { return this.enabled && !this._muted; };
...
SoundNotificationManager.prototype.destroy = function() { this._sounds = {}; };

export function info() { return { moduleId: MODULE_ID, version: VERSION }; }
export function healthCheck() { return { status: 'HEALTHY', moduleId: MODULE_ID, version: VERSION }; }
export default { SoundNotificationManager, SOUNDS, info, healthCheck };
