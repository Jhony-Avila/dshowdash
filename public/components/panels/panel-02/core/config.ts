...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-02/core/config
// PURPOSE: Panel-02 - Runtime Configuration
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-02/core/config';
...
export const getErrorMessage = (errorCode: string) => (ERROR_MESSAGES as Record<string, string>)[errorCode] || 'Erro ao carregar dados';
