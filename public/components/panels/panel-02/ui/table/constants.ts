...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-02/ui/table/constants
// PURPOSE: Panel-02 Table Constants
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   TYPE_ICONS — exported value
//   COLUMNS — exported value
//   STATUS_ORDER — exported value
...
export const MODULE_ID = 'panel-02/ui/table/constants';
...
export const COLUMNS = [
  ...
  { id: 'job_name', label: 'Job', sortable: true, visible: true, width: null as number | null, filterable: true, filterType: 'text' },
...
export const STATUS_ORDER = { 'critical': 0, 'warning': 1, 'healthy': 2, 'inactive': 3 };

export const GROUP_LABELS = {
  'api': 'API', 'python': 'Python', 'php': 'PHP', 'shell': 'Shell',
  'healthy': 'Saudavel', 'warning': 'Atencao', 'critical': 'Critico', 'inactive': 'Inativo'
};

export default { VERSION, MODULE_ID, TYPE_ICONS, COLUMNS, STATUS_ORDER, GROUP_LABELS };

export function info() { return { moduleId: 'panels-ui-table-constants', version: VERSION || '1.0.0' }; }
export function healthCheck() { return { status: 'HEALTHY', moduleId: 'panels-ui-table-constants', version: VERSION || '1.0.0', checks: { constantsLoaded: true } }; }
