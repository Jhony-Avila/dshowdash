...
const MODULE_ID = "panel-03.ui.toast";
...
function healthCheck() {
  return { status: _getToast() ? "HEALTHY" : "NOT_INITIALIZED", moduleId: MODULE_ID, version: VERSION, portsInitialized: Ports.isInitialized() };
}
export {
  MODULE_ID,
  ToastManager,
