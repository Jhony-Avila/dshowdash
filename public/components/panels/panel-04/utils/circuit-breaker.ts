...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-04/utils/circuit-breaker
// PURPOSE: Panel-04 Circuit Breaker
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-04/utils/circuit-breaker';
...
export class CircuitBreaker {
  ...
  recordFailure(error: Error | string | null = null) {
    this.failures++;
