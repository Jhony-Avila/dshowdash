...
function _template() {
  ...
  <div class="p05-panel" data-panel="${PANEL_ID}" data-ref="panel" style="position:relative">
    <header class="p05-header">
      ...
      <div class="p05-header-left">
        <div class="p05-view-toggle">
          ...
          <button type="button" class="p05-view-btn" data-action="toggle-charts" title="Gr\xE1ficos e insights (c)">Gr\xE1ficos</button>
        </div>
      </div>
    ...
    <div class="p05-content">
      ...
      <section class="p05-charts-section" data-region="charts" data-ref="chartsArea" style="display:none" aria-label="Gr\xE1ficos e insights"></section>
