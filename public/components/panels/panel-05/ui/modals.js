...
const MODULE_ID = "panel-05:modals";
...
const DATE_PRESETS = [
  ...
  { id: "7d", label: "Ultimos 7 dias", getValue: () => {
    const e = /* @__PURE__ */ new Date();
    const s = /* @__PURE__ */ new Date();
    s.setDate(s.getDate() - 7);
    return { start: s, end: e };
  } },
  { id: "30d", label: "Ultimos 30 dias", getValue: () => {
    const e = /* @__PURE__ */ new Date();
    const s = /* @__PURE__ */ new Date();
    s.setDate(s.getDate() - 30);
    return { start: s, end: e };
  } },
  { id: "90d", label: "Ultimos 90 dias", getValue: () => {
    const e = /* @__PURE__ */ new Date();
    const s = /* @__PURE__ */ new Date();
    s.setDate(s.getDate() - 90);
    return { start: s, end: e };
  } },
  { id: "thisMonth", label: "Este mes", getValue: () => {
    const d = /* @__PURE__ */ new Date();
    return { start: new Date(d.getFullYear(), d.getMonth(), 1), end: new Date(d.getFullYear(), d.getMonth() + 1, 0) };
  } },
  { id: "lastMonth", label: "Mes passado", getValue: () => {
    const d = /* @__PURE__ */ new Date();
...
class ModalsManager {
  ...
  renderDateRangePicker(options = {}) {
    const { startDate = null, endDate = null, selectedPreset = null } = options;
    const today = /* @__PURE__ */ new Date();
    const currentMonth = Number.isInteger(options.month) ? options.month : today.getMonth();
    const currentYear = Number.isInteger(options.year) ? options.year : today.getFullYear();
  ...
  _renderCalendar(month, year, startDate, endDate) {
    if (month < 0) {
      month = 11;
      year--;
    }
  ...
  _loadSettings() {
    const defaults = { theme: "system", compactMode: false, autoRefresh: true, refreshInterval: 60, itemsPerPage: 25 };
    try {
      const saved = localStorage.getItem("p05_settings");
  ...
  saveSettings(settings) {
    ...
    try {
      localStorage.setItem("p05_settings", JSON.stringify(this._settings));
    } catch (e) {
    }
  ...
  resetSettings() {
    this._settings = { theme: "system", compactMode: false, autoRefresh: true, refreshInterval: 60, itemsPerPage: 25 };
    try {
      localStorage.removeItem("p05_settings");
    } catch (e) {
    }
    return this._settings;
  }
  _formatKey(key) {
    const keyMap = { "ArrowUp": "\u2191", "ArrowDown": "\u2193", "ArrowLeft": "\u2190", "ArrowRight": "\u2192", "Ctrl": "Ctrl", "Alt": "Alt", "Shift": "Shift", "Enter": "\u21B5", "Esc": "Esc", "Tab": "Tab", "Home": "Home", "End": "End" };
    return keyMap[key] || key;
  }
  info() {
    return { moduleId: MODULE_ID, version: VERSION, settings: this._settings, source: "IconRegistry" };
  }
  healthCheck() {
...
var modals_default = modalsManager;
export {
  MODULE_ID,
  VERSION,
