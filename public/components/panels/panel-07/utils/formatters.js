const MODULE_ID = "panel-07/utils/formatters";
...
function info() {
  return { moduleId: MODULE_ID, version: VERSION, formattersCount: 10, p25Compliant: true };
}
var formatters_default = { formatDuration, formatDateTime, formatDateTimeFull, escapeHtml, formatNumber, formatPercent, formatBytes, getRateClass, getHealthClass, getHealthText, healthCheck, info };
export {
  MODULE_ID,
  VERSION,
