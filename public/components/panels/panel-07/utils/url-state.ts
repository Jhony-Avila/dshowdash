...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-07/utils/url-state
// PURPOSE: Panel-07 URL State - Shim para RouteStateService
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-07/utils/url-state';
...
URLState.prototype.subscribe = (callback: (state: unknown) => void) => RouteStateService.subscribe(PANEL_ID, callback);
