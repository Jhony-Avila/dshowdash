...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-08/icons
// PURPOSE: panel-08 - Icons (IconRegistry Adapter)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-08/icons';
...
export const ICONS = new Proxy({} as Record<string, string>, {
  get(target: Record<string, string>, prop: string | symbol): string | undefined {
