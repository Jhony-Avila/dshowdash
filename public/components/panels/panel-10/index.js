...
import { PAINEL_ID, PANEL_TITLE, REFRESH_INTERVAL_SECONDS, MAX_CONSECUTIVE_ERRORS, CIRCUIT_BREAKER_THRESHOLD, CIRCUIT_BREAKER_TIMEOUT, STATES, DEFAULT_PERFORMANCE_METRICS } from "./core/constants.js";
const MODULE_ID = "panel-10";
...
const unmount = (_container, _deps) => {
  if (!instance) return Promise.resolve();
  return instance.unmount().then(() => {
    instance = null;
  });
};
...
var panel_10_default = { mount, unmount, destroy, getStatus, getVersion, healthCheck, info, injectPorts, getPorts };
export {
  MODULE_ID,
  PAINEL_ID as PANEL_ID,
  VERSION,
  panel_10_default as default,
  destroy,
  getPorts,
  getStatus,
  getVersion,
