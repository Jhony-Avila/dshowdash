...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-11
// PURPOSE: Panel-11 Constants - Resumo Geral Enterprise Premium AAA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const PAINEL_ID = 'panel-11';
export const MODULE_ID = 'panel-11.core.constants';
export const VERSION = '9.3.0-P2-ENTERPRISE';
export const PANEL_TITLE = 'Resumo Geral';
...
// CSS Path
export const CSS_PATH = '/components/panels/panel-11/styles/index.css';
...
export const HEALTH_STATUS = {
  ...
  warning: { label: 'Atenção', color: '#f59e0b', bg: 'rgba(245,158,11,0.15)', border: 'rgba(245,158,11,0.25)' },
  critical: { label: 'Crítico', color: '#ef4444', bg: 'rgba(239,68,68,0.15)', border: 'rgba(239,68,68,0.25)' }
};

// Severity Config
export const SEVERITY = {
  low: { label: 'Baixo', color: '#22c55e', bg: 'rgba(34,197,94,0.12)', border: 'rgba(34,197,94,0.25)' },
  medium: { label: 'Médio', color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', border: 'rgba(245,158,11,0.25)' },
...
// SLA Target
export const SLA_TARGET = 95.0;

// SVG Icons (inline, dark-mode ready)
export const ICONS = {
...
export function info() { return { moduleId: 'panels-panel-11-core-constants', version: VERSION || '1.0.0' }; }
export function healthCheck() { return { status: 'HEALTHY', moduleId: 'panels-panel-11-core-constants', version: VERSION || '1.0.0', checks: { constantsLoaded: true } }; }
