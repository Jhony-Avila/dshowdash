...
const MODULE_ID = "panel-12.core.header-template";
function renderHeader(panelId) {
  return `
      ...
      <div class="painel-12-header-row-1">
        ...
        <div class="painel-12-header-actions">
          <div class="painel-12-search-container">
            ...
            <button class="painel-12-search-clear" id="search-clear-${panelId}" aria-label="Limpar busca">\xD7</button>
          ...
          <button id="btn-columns-${panelId}" class="painel-12-btn-columns" title="Selecionar colunas" aria-label="Selecionar colunas vis\xEDveis">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
