...
var panel_13_default = { mount, unmount, destroy, getStatus, getVersion, healthCheck, info, injectPorts, getPorts };
export {
  MODULE_ID,
  PAINEL_ID as PANEL_ID,
  VERSION,
  panel_13_default as default,
  destroy,
  getPorts,
  getStatus,
  getVersion,
