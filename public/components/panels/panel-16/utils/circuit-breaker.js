...
const MODULE_ID = "panel-16/utils/circuit-breaker";
...
CircuitBreaker.prototype.healthCheck = function() {
  ...
  const checks = { notOpen: this._state !== "OPEN", belowThreshold: this._failures < this._threshold };
  let passed = 0;
...
CircuitBreaker.prototype.getMetrics = function() {
  return { failures: this._failures || 0, successes: this._successes || 0, totalRequests: this._totalRequests || 0 };
};
...
var circuit_breaker_default = { CircuitBreaker, VERSION, MODULE_ID, getVersion };
export {
  CircuitBreaker,
  MODULE_ID,
  VERSION,
