...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-17
// PURPOSE: Panel-17 Constants - FONTE CANÔNICA
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const PAINEL_ID = 'panel-17';
export const MODULE_ID = 'panel-17.core.constants';
export const VERSION = '9.3.0-P2-ENTERPRISE';
export const PANEL_TITLE = 'Orçamento Clientes';
...
export function info() { return { moduleId: 'panels-panel-17-core-constants', version: VERSION }; }
export function healthCheck() { return { status: 'HEALTHY', moduleId: 'panels-panel-17-core-constants', version: VERSION, checks: { constantsLoaded: true } }; }
