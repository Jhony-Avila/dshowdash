...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-17/utils/url-state
// PURPOSE: Panel-17 URL State - Shim para RouteStateService
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-17/utils/url-state';
const PANEL_ID = 'panel-17';
...
URLState.prototype.subscribe = (callback: () => void) => RouteStateService.subscribe(PANEL_ID, callback);
