...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-18/core/config
// PURPOSE: Panel-18 - Runtime Configuration
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-18/core/config';
...
export const getErrorMessage = (errorCode: keyof typeof ERROR_MESSAGES | string): string => (ERROR_MESSAGES as Record<string, string>)[errorCode] || 'Erro ao carregar dados';
