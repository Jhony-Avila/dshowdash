...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-18:countdown
// PURPOSE: Panel-18 - Countdown
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-18:countdown';
...
export function pause(panel: PanelContext) {
  panel.autoRefreshEnabled = false;
  setAutoRefreshState(panel.container, false);
}

export function resume(panel: PanelContext) {
