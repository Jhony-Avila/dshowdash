// vite.config.ts — build do painel Anúncios (Consultor Google Ads / Decision Engine).
...
//
// Build:  npx vite build --config public/components/panels/panel-anuncios/vite.config.ts
...
export default defineConfig({
  ...
  css: {
    modules: {
      generateScopedName: '__anx_[local]_[hash:base64:5]',
    },
  },
  ...
  build: {
    ...
    rollupOptions: {
      ...
      output: {
        format: 'es',
        entryFileNames: 'anuncios.[hash].js',
