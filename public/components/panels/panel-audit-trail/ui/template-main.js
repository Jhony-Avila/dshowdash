    ...
    <div class="${CSS_PREFIX}-container" data-panel="audit-trail" role="region" aria-label="Auditoria e Logs">
      <header class="${CSS_PREFIX}-header">
        ...
        <div class="${CSS_PREFIX}-health-summary" data-health-summary>
          <span class="${CSS_PREFIX}-health-item ${CSS_PREFIX}-health-item--error" data-health="error" data-tooltip="Eventos cr\xEDticos"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M15 9l-6 6M9 9l6 6"/></svg><span class="${CSS_PREFIX}-health-count" data-count="error">0</span><span>Erros</span></span>
          ...
          <span class="${CSS_PREFIX}-health-item ${CSS_PREFIX}-health-item--info" data-health="info" data-tooltip="Informa\xE7\xF5es"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg><span class="${CSS_PREFIX}-health-count" data-count="info">0</span><span>Info</span></span>
          <span class="${CSS_PREFIX}-health-item ${CSS_PREFIX}-health-item--security" data-health="security" data-tooltip="Seguran\xE7a"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg><span class="${CSS_PREFIX}-health-count" data-count="security">0</span><span>Seguran\xE7a</span></span>
        </div>
          ...
          <div class="${CSS_PREFIX}-actions-cluster">
            ...
            <div class="${CSS_PREFIX}-export-dropdown">
              ...
              <div class="${CSS_PREFIX}-export-menu" data-export-menu>
                ...
                <div class="${CSS_PREFIX}-export-item ${CSS_PREFIX}-export-item--csv" data-action="export-csv"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h2"/><path d="M8 17h2"/><path d="M14 13h2"/><path d="M14 17h2"/></svg><div><div class="${CSS_PREFIX}-export-item-label">CSV</div><div class="${CSS_PREFIX}-export-item-desc">Planilha separada por v\xEDrgulas</div></div></div>
      ...
      <div class="${CSS_PREFIX}-filters" data-filters>
        ...
        <div class="${CSS_PREFIX}-grid-controls">
          <select class="${CSS_PREFIX}-group-select" data-action="group-by" data-tooltip="Agrupar"><option value="">Sem grupo</option><option value="action_type">Por A\xE7\xE3o</option><option value="module">Por M\xF3dulo</option><option value="severity">Por Severidade</option><option value="username">Por Usu\xE1rio</option></select>
          ...
          <div class="${CSS_PREFIX}-columns-dropdown"><button class="${CSS_PREFIX}-columns-btn" data-action="toggle-columns" type="button" data-tooltip="Colunas"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg></button><div class="${CSS_PREFIX}-columns-menu" data-columns-menu><div class="${CSS_PREFIX}-columns-menu-header">Colunas Vis\xEDveis</div></div></div>
...
var template_main_default = { buildTemplate };
const MODULE_ID = "panels-panel-audit-trail-ui-template-main";
const VERSION = "9.3.0-P2-ENTERPRISE";
function info() {
  return { moduleId: MODULE_ID, version: VERSION };
}
function healthCheck() {
  return { status: "HEALTHY", moduleId: MODULE_ID, version: VERSION, checks: { templateMainReady: true } };
}
export {
  MODULE_ID,
  VERSION,
  buildTemplate,
  template_main_default as default,
  healthCheck,
  info
};
