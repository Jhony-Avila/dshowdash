...
export async function mountReact(contentEl: HTMLElement, config: ShellConfig = {}): Promise<void> {
  ...
  // lote 1201-1210 (#122, as6.contextos_v6): API GLOBAL do Universal
  // Avatar Component — qualquer painel do dash (vanilla incluso) monta
  // o avatar salvo com uma chamada; contrato estável fora do React
  if (flag('as6.contextos_v6')) {
    (window as unknown as { AvatarStudioUniversal?: { montarAvatar: typeof montarAvatarUniversal } })
      .AvatarStudioUniversal = { montarAvatar: montarAvatarUniversal };
  }
