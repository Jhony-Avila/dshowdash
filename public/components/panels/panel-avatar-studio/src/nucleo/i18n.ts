...
const EN: Record<string, string> = {
  ...
  // onda 1361+ (as6.tax_v2): taxonomia v2 — mães, principais, ferramentas
  'Cabeça e Rosto': 'Head & Face',
  'Joias e Adornos': 'Jewelry & Adornments',
  'Equipamentos': 'Equipment',
  'Costas e Mobilidade': 'Back & Mobility',
  'Companheiros': 'Companions',
  'Elementos Especiais': 'Special Elements',
  'Ambiente e Cenário': 'Environment & Scenery',
  'Identidade Visual': 'Visual Identity',
  'Ferramentas e gestão': 'Tools & management',
  'Em breve': 'Coming soon',
  'Em breve — novas categorias em preparação': 'Coming soon — new categories in preparation',
  'Em breve — novos assets em preparação': 'Coming soon — new assets in preparation',
  'Coberturas de cabeça': 'Head coverings',
  'Adornos de cabeça': 'Head adornments',
  'Visão': 'Eyewear',
  'Proteção facial': 'Face protection',
  'Modificações faciais': 'Facial modifications',
  'Áudio e comunicação': 'Audio & communication',
  'Orelhas': 'Ears',
  'Pescoço': 'Neck',
  'Peito': 'Chest',
  'Braços e pulsos': 'Arms & wrists',
  'Mãos e dedos': 'Hands & fingers',
  'Cintura e quadril': 'Waist & hips',
  'Pernas e tornozelos': 'Legs & ankles',
  'Capas': 'Capes',
  'Propulsores': 'Thrusters',
  'Mochilas e bolsas': 'Backpacks & bags',
  'Drones': 'Drones',
  'Pets': 'Pets',
  'Robôs': 'Robots',
  'Espíritos': 'Spirits',
  'Auréolas': 'Halos',
  'Energia corporal': 'Body energy',
  'Runas e círculos': 'Runes & circles',
  'Calçados': 'Footwear',
  'Missões': 'Missions',
  'Evolução': 'Evolution',
