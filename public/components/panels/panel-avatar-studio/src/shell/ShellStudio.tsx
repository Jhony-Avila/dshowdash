...
import { useMobileStudio, useTecladoVirtual, useBackGuard, useFocoDialogo } from '../workspace/mobileStudio'; // Track C: composição mobile
...
export function ShellStudio({ configInicial, versaoBase, desbloqueados, vida = null, vidaCarregando = false, aoSalvarLegado, aoSalvarFotoLegado, aoSairDoShell }: {
  ...
  useFocoDialogo(mobileStudio); // Track C: foco entra no diálogo e retorna à origem ao fechar
