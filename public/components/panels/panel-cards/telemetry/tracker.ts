...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-cards.telemetry.tracker
// PURPOSE: Panel Cards - Telemetry Tracker Enterprise
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
const MODULE_ID = 'panel-cards.telemetry.tracker';
...
PanelTelemetryTracker.prototype.trackError = function(error: Error | unknown, context = {}) { this.metrics.errorCount++; return this.track(LIFECYCLE_EVENTS.ERROR, { error: (error as Error)?.message || String(error), errorType: (error as Error)?.name || 'Error', context, totalErrors: this.metrics.errorCount }); };
