...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-charts/accessibility/announce
// PURPOSE: Charts - Accessibility Announcer (Autocontido AAA)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-charts/accessibility/announce';
...
function _ensureContainer() {
  if (!_container) {
    ...
    const panel = document.querySelector('[data-panel="panel-charts"]') || document.querySelector('.panel-charts');
