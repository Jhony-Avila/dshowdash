...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-code/api/alerts
// PURPOSE: Código - API Alerts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-code/api/alerts';

interface AlertEntry extends Record<string, unknown> {
  id: number;
  timestamp: string;
  type?: string;
}

const _alerts: AlertEntry[] = [];
let _maxAlerts = 100;
