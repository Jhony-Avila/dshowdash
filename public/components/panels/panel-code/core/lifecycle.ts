...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-code.core.lifecycle
// PURPOSE: Código - Lifecycle Manager
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-code.core.lifecycle';
...
export class LifecycleManager {
  ...
  onBeforeMount(h: (component: unknown) => Promise<void> | void) { this.hooks.beforeMount.push(h); }
  onMounted(h: (component: unknown) => Promise<void> | void) { this.hooks.mounted.push(h); }
  onBeforeUnmount(h: (component: unknown) => Promise<void> | void) { this.hooks.beforeUnmount.push(h); }
  onUnmounted(h: (component: unknown) => Promise<void> | void) { this.hooks.unmounted.push(h); }
