...
const MODULE_ID = "panels/panel-code";
...
const CONFIG = { id: "code", area: "panel", label: "C\xF3digo", icon: "code", emoji: "\u{1F4BB}", kind: "panel-component" };
let _debug = false;
...
var panel_code_default = { CodeComponent, createCode, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  CodeComponent,
  MODULE_ID,
  VERSION,
  createCode,
  panel_code_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
