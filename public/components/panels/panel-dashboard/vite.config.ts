// vite.config.ts — build do painel Visão Geral (dashboard executivo).
...
//
// Build:  npx vite build --config public/components/panels/panel-dashboard/vite.config.ts
...
export default defineConfig({
  ...
  css: {
    modules: {
      generateScopedName: '__ger_[local]_[hash:base64:5]',
    },
  },
