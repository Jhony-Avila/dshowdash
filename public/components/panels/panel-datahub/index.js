...
const MODULE_ID = "panels/panel-datahub";
...
const CONFIG = { id: "datahub", area: "panel", label: "Data Hub", icon: "datahub", emoji: "\u{1F5C4}\uFE0F", kind: "panel-component" };
let _debug = false;
...
const healthCheck = () => {
  ...
  return { ...hc, isDocumentVisible: _isDocumentVisible() };
};
var panel_datahub_default = { DatahubComponent, createDatahub, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  DatahubComponent,
  MODULE_ID,
  VERSION,
  createDatahub,
  panel_datahub_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
