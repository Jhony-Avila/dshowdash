...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-feature-flags-admin/core/config
// PURPOSE: Panel Feature Flags Admin - Runtime Configuration
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panel-feature-flags-admin/core/config';
...
export const ERROR_MESSAGES = Object.freeze({ 'AUTH_REQUIRED': 'Autenticação necessária', 'REQUEST_ABORTED': 'Requisição cancelada', 'REQUEST_TIMEOUT': 'Tempo esgotado', 'NETWORK_ERROR': 'Erro de rede', 'HTTP_500': 'Erro interno do servidor', 'HTTP_401': 'Sessão expirada', 'HTTP_403': 'Acesso negado', 'HTTP_404': 'Endpoint não encontrado', 'CIRCUIT_BREAKER_OPEN': 'Serviço temporariamente indisponível' });
