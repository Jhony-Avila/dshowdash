...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-files/api/alerts
// PURPOSE: Arquivos - API Alerts
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-files/api/alerts';
...
export function remove(id: unknown) {
...
export function getByType(type: unknown) { return _alerts.filter(a => a.type === type); }
