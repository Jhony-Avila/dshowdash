...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-files/state/updaters
// PURPOSE: Arquivos - State Updaters
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-files/state/updaters';

export function setLoading(store: { setState: (u: Record<string, unknown>) => void }, loading: boolean) { store.setState({ loading }); }
export function setError(store: { setState: (u: Record<string, unknown>) => void }, error: unknown) { store.setState({ error, loading: false }); }
