...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-docs/accessibility/announce
// PURPOSE: Footer Docs - Accessibility Announcer (Autocontido AAA)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-footer-docs/accessibility/announce';
...
function _ensureContainer() {
  if (!_container) {
    ...
    const panel = document.querySelector('[data-panel="panel-footer-docs"]') || document.querySelector('.panel-footer-docs');
