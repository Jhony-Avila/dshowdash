...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-file/accessibility/announce
// PURPOSE: Footer File - Accessibility Announcer (Autocontido AAA)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-footer-file/accessibility/announce';
...
function _ensureContainer() {
  if (!_container) {
    ...
    const panel = document.querySelector('[data-panel="panel-footer-file"]') || document.querySelector('.panel-footer-file');
