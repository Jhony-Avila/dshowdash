...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-settings/core/lifecycle
// PURPOSE: Footer - Lifecycle Manager
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panels/panel-footer-settings/core/lifecycle';
...
export class LifecycleManager {
  ...
  onBeforeMount(h: () => void | Promise<void>) { this.hooks.beforeMount.push(h); }
  onMounted(h: () => void | Promise<void>) { this.hooks.mounted.push(h); }
  onBeforeUnmount(h: () => void | Promise<void>) { this.hooks.beforeUnmount.push(h); }
  onUnmounted(h: () => void | Promise<void>) { this.hooks.unmounted.push(h); }
