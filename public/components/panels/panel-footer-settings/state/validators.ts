...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-settings/state/validators
...
export const MODULE_ID = 'panels/panel-footer-settings/state/validators';

export function isValidState(state: unknown) { return state !== null && typeof state === 'object'; }
export function hasRequiredFields(state: Record<string, unknown>, fields: string[]) { return fields.every(f => state.hasOwnProperty(f)); }
