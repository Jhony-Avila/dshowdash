...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-settings/utils/dom
// PURPOSE: Footer Settings - DOM Utilities
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-footer-settings/utils/dom';
export const qs = (selector: string, context = document) => context.querySelector(selector);
export const qsa = (selector: string, context = document) => Array.from(context.querySelectorAll(selector));
