...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-footer-status/accessibility/announce
// PURPOSE: Footer Status - Accessibility Announcer (Autocontido AAA)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-footer-status/accessibility/announce';
...
function _ensureContainer() {
  if (!_container) {
    ...
    const panel = document.querySelector('[data-panel="panel-footer-status"]') || document.querySelector('.panel-footer-status');
