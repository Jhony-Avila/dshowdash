...
const MODULE_ID = "panels/panel-footer-support/telemetry/tracker";
...
class Tracker {
  constructor(options = {}) {
    _initPorts();
    this.moduleId = options.moduleId || "panels/panel-footer-support";
  ...
  healthCheck() {
    ...
    return { status: "healthy", enabled: this.enabled, eventCount: this._events.length, portsInitialized: ps._initialized, p18IntentsAvailable: true, version: VERSION, moduleId: MODULE_ID };
  }
  info() {
    const ps = Ports.snapshot();
