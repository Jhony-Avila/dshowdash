...
const MODULE_ID = "panel-health-dashboard.constants";
const PANEL_TITLE = "System Health Dashboard";
const ICONS = {
  ...
  kernel: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg>',
...
const STATUS_CONFIG = {
  HEALTHY: { icon: "check", color: "#22c55e", bg: "rgba(34,197,94,0.15)", label: "Healthy" },
  DEGRADED: { icon: "alertTriangle", color: "#f59e0b", bg: "rgba(245,158,11,0.15)", label: "Degraded" },
  UNHEALTHY: { icon: "x", color: "#ef4444", bg: "rgba(239,68,68,0.15)", label: "Unhealthy" },
  UNAVAILABLE: { icon: "circle", color: "#606070", bg: "rgba(96,96,112,0.15)", label: "Unavailable" },
  UNKNOWN: { icon: "circle", color: "#606070", bg: "rgba(96,96,112,0.15)", label: "Unknown" },
  NOT_INITIALIZED: { icon: "circle", color: "#8b5cf6", bg: "rgba(139,92,246,0.15)", label: "Not Init" },
  IDLE: { icon: "circle", color: "#64748b", bg: "rgba(100,116,139,0.15)", label: "Idle" },
  ERROR: { icon: "x", color: "#ef4444", bg: "rgba(239,68,68,0.15)", label: "Error" }
};
const CATEGORY_CONFIG = {
  kernels: { label: "Kernels", icon: "kernel", priority: 0 },
  core: { label: "Core Infrastructure", icon: "cpu", priority: 1 },
  components: { label: "Components", icon: "box", priority: 2 },
  panels: { label: "Panels", icon: "layout", priority: 3 }
};
const CONFIG = { refreshInterval: 3e4, autoRefresh: true };
...
function info() {
  return { moduleId: "panel-health-dashboard-constants", version: VERSION };
}
function healthCheck() {
  return { status: "HEALTHY", moduleId: "panel-health-dashboard-constants", version: VERSION, checks: { constantsLoaded: true } };
}
export {
  CATEGORY_CONFIG,
  CONFIG,
