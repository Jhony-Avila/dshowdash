...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels-panels-panel-health-dashboard-modal
// PURPOSE: Panel Health Dashboard - Modal
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   ICONS, STATUS_CONFIG from ./constants.js
//   selectors from ./state/store.js
//
// PROVIDES:
//   showModuleDetails() — exported function
...
export const MODULE_ID = 'panels-panels-panel-health-dashboard-modal';
export const VERSION = '9.3.0-P2-ENTERPRISE';
export function info() { return { moduleId: MODULE_ID, version: VERSION }; }
export function healthCheck() { return { status: 'HEALTHY', moduleId: MODULE_ID, version: VERSION, checks: { modalReady: true } }; }
