...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-integration-asaas/accessibility/announce
// PURPOSE: Integration Asaas - Accessibility Announcer (Autocontido AAA)
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-integration-asaas/accessibility/announce';
...
function _ensureContainer() {
  if (!_container) {
    ...
    const panel = document.querySelector('[data-panel="panel-integration-asaas"]') || document.querySelector('.panel-integration-asaas');
