...
const MODULE_ID = "panels/panel-integration-bling";
...
const CONFIG = { id: "integration-bling", area: "integration", label: "Bling", emoji: "\u{1F4E6}", apiEndpoint: "/api/status/bling.php", refreshInterval: 12e4 };
class IntegrationBlingComponent {
  constructor(options = {}) {
    _initPorts();
...
var panel_integration_bling_default = { IntegrationBlingComponent, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  IntegrationBlingComponent,
  MODULE_ID,
  VERSION,
  panel_integration_bling_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
