...
export const mount = (container: any, config: any) => { const i = new IntegrationBlingComponent({ container, config }); i.init(); i.mount(container); _currentInstance = i; return { success: true, moduleId: MODULE_ID, instance: i }; };
