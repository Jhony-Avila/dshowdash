...
const MODULE_ID = "panel-integration-calendar.telemetry.tracker";
...
class Tracker {
  constructor(options = {}) {
    this.moduleId = options.moduleId || "panel-integration-calendar";
  ...
  healthCheck() {
    return { status: Ports.isInitialized() ? "HEALTHY" : "DEGRADED", enabled: this.enabled, eventCount: this._events.length, version: VERSION, moduleId: MODULE_ID, portsInitialized: Ports.isInitialized(), p18IntentsAvailable: true };
  }
  info() {
