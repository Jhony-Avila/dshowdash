...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-integration-loja-integrada/core/polling
// PURPOSE: Integration Loja Integrada - Polling Manager
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panels/panel-integration-loja-integrada/core/polling';
...
export class PollingManager {
  ...
  info() { return { version: VERSION, moduleId: MODULE_ID, running: this._running, interval: this.interval, metrics: this._metrics, portsInitialized: Ports.isInitialized() }; }
