...
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-integration-pipedrive.state.store
// PURPOSE: Integração - State Store
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-integration-pipedrive.state.store';
...
export class StateStore {
  ...
  setState(updates: Record<string, unknown>) {
    ...
    this.subscribers.forEach((s: (state: Record<string, unknown>, prev: Record<string, unknown>) => void) => {
      try {
        s(this.state, prev);
