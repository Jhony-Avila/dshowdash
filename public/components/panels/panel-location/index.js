...
const MODULE_ID = "panels/panel-location";
...
const CONFIG = { id: "location", area: "panel", label: "Localiza\xE7\xE3o", icon: "location", emoji: "\u{1F4CD}", kind: "panel-component" };
let _debug = false;
...
class LocationComponent {
  ...
  _updateLoadingUI(loading) {
    ...
    if (statusEl) {
      statusEl.setAttribute("data-status", isLoading ? "loading" : "ready");
...
var panel_location_default = { LocationComponent, createLocation, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  LocationComponent,
  MODULE_ID,
  VERSION,
  createLocation,
  panel_location_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
