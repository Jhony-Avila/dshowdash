...
//
// Build:  npx vite build --config public/components/panels/panel-mercadolivre/vite.config.ts
...
export default defineConfig({
  ...
  css: {
    modules: {
      generateScopedName: '__ml_[local]_[hash:base64:5]',
    },
  },
