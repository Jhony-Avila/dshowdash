...
//
// Build:  npx vite build --config public/components/panels/panel-metaads/vite.config.ts
...
export default defineConfig({
  ...
  css: {
    modules: {
      generateScopedName: '__mads_[local]_[hash:base64:5]',
    },
  },
