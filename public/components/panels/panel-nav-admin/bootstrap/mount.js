var VERSION = "9.4.0-P18EC-ENTERPRISE";
var MODULE_ID = "panels.panel-nav-admin.bootstrap.mount";
import { initLifecycle } from "../core/lifecycle.js";
var _mounted = false;
var _container = null;
var _refs = {};
function _buildRefs(container) {
  if (!container) return {};
  return {
    container,
...
var mount_default = { mount, unmount, isMounted, getRefs };
export {
  MODULE_ID,
  VERSION,
