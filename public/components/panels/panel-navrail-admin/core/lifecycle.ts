...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-navrail-admin/core/lifecycle
// PURPOSE: NavRail Admin - Lifecycle Manager
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panels/panel-navrail-admin/core/lifecycle';
...
export class LifecycleManager {
  ...
  onBeforeMount(h: (c: unknown) => unknown) { this.hooks.beforeMount.push(h); }
  onMounted(h: (c: unknown) => unknown) { this.hooks.mounted.push(h); }
  onBeforeUnmount(h: (c: unknown) => unknown) { this.hooks.beforeUnmount.push(h); }
  onUnmounted(h: (c: unknown) => unknown) { this.hooks.unmounted.push(h); }
...
export { LifecycleManager as PanelLifecycle };
