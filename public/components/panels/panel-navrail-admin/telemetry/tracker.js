...
const MODULE_ID = "panels/panel-navrail-admin/telemetry/tracker";
...
class Tracker {
  ...
  info() {
    const ps = Ports.snapshot();
    return { version: VERSION, moduleId: MODULE_ID, enabled: this.enabled, eventCount: this._events.length, portsInitialized: ps._initialized, usingP18Intents: true };
  }
}
var tracker_default = Tracker;
export {
  MODULE_ID,
  Tracker as PanelTracker,
  Tracker,
  VERSION,
