// ═══════════════════════════════════════════════════════════════
// DEPENDENCY CONTRACT (8.3.0-P18G2-AAA)
// ═══════════════════════════════════════════════════════════════
// MODULE: panel-observability
// PURPOSE: Panel Observability - Constants
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
export const MODULE_ID = 'panel-observability.core.constants';
export const PANEL_ID = 'panel-observability';

export const REFRESH_INTERVAL = 30000;
export const REFRESH_INTERVAL_DEGRADED = 60000;

export const HEALTH_STATUS = Object.freeze({ HEALTHY: 'HEALTHY', DEGRADED: 'DEGRADED', UNHEALTHY: 'UNHEALTHY', UNKNOWN: 'unknown' });
...
export default { VERSION, MODULE_ID, PANEL_ID, REFRESH_INTERVAL, HEALTH_STATUS, ICONS };
