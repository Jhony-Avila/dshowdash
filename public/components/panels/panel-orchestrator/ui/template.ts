...
// ═══════════════════════════════════════════════════════════════
// MODULE: orchestrator-ui-template
// PURPOSE: Orchestrator UI Template
// ───────────────────────────────────────────────────────────────
// IMPORTS:
...
//   createOrchestratorTemplate() — exported function
//   createPanelListItem() — exported function
//   createStatusBadge() — exported function
//
...
const createStatusBadge = (status: string) => {
  const statusColors: Record<string, string> = { RUNNING: 'success', READY: 'success', INITIALIZING: 'warning', PAUSED: 'info', ERROR: 'danger', DEGRADED: 'warning' };
...
export { VERSION, MODULE_ID, getVersion, createOrchestratorTemplate, createPanelListItem, createStatusBadge };

export default { VERSION, MODULE_ID, getVersion, createOrchestratorTemplate, createPanelListItem, createStatusBadge };
