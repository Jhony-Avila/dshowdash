...
// ═══════════════════════════════════════════════════════════════
// MODULE: uarps-icons-system
// PURPOSE: UARPS Admin - Sistema Híbrido de Ícones
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
//   Lucide — exported value
//   SERVER_ICONS_PATH — exported value
//   TRIGGER_TO_SERVER_ICON — exported value
//   AREA_TO_SERVER_ICON — exported value
//   TRIGGER_PATTERNS — exported value
//   getLucideIcon() — exported function
//   getServerIconUrl() — exported function
//   serverIconImg() — exported function
//   getAreaLucideIcon() — exported function
//   getCustomMappings() — exported function
//   setCustomMapping() — exported function
//   getIconWithCustom() — exported function
...
export const MODULE_ID = 'uarps-icons-system';
...
export const SERVER_ICONS_PATH = '/assets/icons/system';

export const TRIGGER_TO_SERVER_ICON = {
...
export const AREA_TO_SERVER_ICON = {
...
export function getLucideIcon(name: string, size: number) {
  if (!size) size = 24;
...
export function getServerIconUrl(triggerId: string, area: string) {
  if ((TRIGGER_TO_SERVER_ICON as Record<string, string>)[triggerId]) {
    return `${SERVER_ICONS_PATH}/${(TRIGGER_TO_SERVER_ICON as Record<string, string>)[triggerId]}`;
  }
  ...
  if (area) {
    ...
    if ((AREA_TO_SERVER_ICON as Record<string, string>)[areaKey]) {
      return `${SERVER_ICONS_PATH}/${(AREA_TO_SERVER_ICON as Record<string, string>)[areaKey]}`;
    }
  }
  return `${SERVER_ICONS_PATH}/${AREA_TO_SERVER_ICON.default}`;
}

export function serverIconImg(triggerId: string, area: string, className: string) {
...
export function getAreaLucideIcon(area: string) {
  const map = {
  ...
  return (Lucide as Record<string, string>)[(map as Record<string, string>)[key]] || Lucide.folder;
}
...
export function setCustomMapping(triggerId: string, iconFile: string) {
  const custom = getCustomMappings();
  custom[triggerId] = iconFile;
  localStorage.setItem(CUSTOM_KEY, JSON.stringify(custom));
}

export function getIconWithCustom(triggerId: string, area: string) {
  const custom = getCustomMappings();
  if (custom[triggerId]) {
