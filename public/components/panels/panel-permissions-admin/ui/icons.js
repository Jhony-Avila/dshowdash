...
const MODULE_ID = "uarps-admin-icons";
const Icons = {
...
function info() {
  return { moduleId: MODULE_ID, version: VERSION, iconCount: Object.keys(Icons).length };
}
function healthCheck() {
  return { status: "HEALTHY", moduleId: MODULE_ID, version: VERSION, checks: { iconsLoaded: Object.keys(Icons).length > 0 } };
}
