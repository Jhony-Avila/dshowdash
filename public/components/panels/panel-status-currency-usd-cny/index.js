...
const MODULE_ID = "panels/panel-status-currency-usd-cny";
...
const CONFIG = { id: "status-currency-usd-cny", area: "status", label: "USD/CNY", icon: "yuan", emoji: "\u{1F1FA}\u{1F1F8}\u{1F1E8}\u{1F1F3}", kind: "panel-component", apiEndpoint: "/api/currencies/get_usd_cny.php", refreshInterval: 6e4 };
class StatusCurrencyUsdCnyComponent {
  constructor(options = {}) {
    _initPorts();
...
var panel_status_currency_usd_cny_default = { StatusCurrencyUsdCnyComponent, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  MODULE_ID,
  StatusCurrencyUsdCnyComponent,
  VERSION,
  panel_status_currency_usd_cny_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
