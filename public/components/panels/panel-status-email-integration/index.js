...
const MODULE_ID = "panels/panel-status-email-integration";
...
const CONFIG = { id: "status-email-integration", area: "status", label: "Email", icon: "mail", emoji: "\u{1F4E7}", kind: "panel-component", apiEndpoint: "/api/integrations/email/status.php", refreshInterval: 6e4 };
class StatusEmailIntegrationComponent {
  constructor(options = {}) {
    _initPorts();
...
var panel_status_email_integration_default = { StatusEmailIntegrationComponent, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  MODULE_ID,
  StatusEmailIntegrationComponent,
  VERSION,
  panel_status_email_integration_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
