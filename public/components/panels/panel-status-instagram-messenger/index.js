...
const MODULE_ID = "panels/panel-status-instagram-messenger";
...
const CONFIG = { id: "status-instagram-messenger", area: "status", label: "Instagram", icon: "instagram", emoji: "\u{1F4F8}", kind: "panel-component", apiEndpoint: "/api/integrations/instagram/status.php", refreshInterval: 6e4 };
class StatusInstagramMessengerComponent {
  constructor(options = {}) {
    _initPorts();
...
var panel_status_instagram_messenger_default = { StatusInstagramMessengerComponent, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  MODULE_ID,
  StatusInstagramMessengerComponent,
  VERSION,
  panel_status_instagram_messenger_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
