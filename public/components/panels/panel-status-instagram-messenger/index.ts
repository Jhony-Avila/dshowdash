...
export const mount = (container: any, config: any) => { const instance = new StatusInstagramMessengerComponent({ container: any, config }); instance.init(); instance.mount(container); _currentInstance = instance; return { success: true, moduleId: MODULE_ID, instance }; };
