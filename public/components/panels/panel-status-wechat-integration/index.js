...
const MODULE_ID = "panels/panel-status-wechat-integration";
...
const CONFIG = { id: "status-wechat-integration", area: "status", label: "WeChat", icon: "wechat", emoji: "\u{1F4AC}", kind: "panel-component", apiEndpoint: "/api/integrations/wechat/status.php", refreshInterval: 6e4 };
class StatusWechatIntegrationComponent {
  constructor(options = {}) {
    _initPorts();
...
const mount = (container, config) => {
  const instance = new StatusWechatIntegrationComponent({ container: any, config });
  instance.init();
...
var panel_status_wechat_integration_default = { StatusWechatIntegrationComponent, mount, unmount, destroy, healthCheck, getVersion, MODULE_ID, VERSION, injectPorts, getPorts };
export {
  MODULE_ID,
  StatusWechatIntegrationComponent,
  VERSION,
  panel_status_wechat_integration_default as default,
  destroy,
  getPorts,
  getVersion,
  healthCheck,
