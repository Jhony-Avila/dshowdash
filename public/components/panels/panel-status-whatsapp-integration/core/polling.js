...
const MODULE_ID = "panels/panel-status-whatsapp-integration/core/polling";
...
class PollingManager {
  ...
  info() {
    return { version: VERSION, moduleId: MODULE_ID, running: this._running, interval: this.interval, metrics: this._metrics, portsInitialized: Ports.isInitialized() };
  }
  getMetrics() {
