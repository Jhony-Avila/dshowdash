...
export const mount = (container: any, config: any) => { const instance = new StatusWhatsappIntegrationComponent({ container, config }); instance.init(); instance.mount(container); _currentInstance = instance; return { success: true, moduleId: MODULE_ID, instance }; };
