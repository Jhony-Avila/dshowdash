...
const MODULE_ID = "panels/panel-status-whatsapp-integration/state/store";
...
class StateStore {
  ...
  info() {
    return { version: VERSION, moduleId: MODULE_ID, subscriberCount: this.subscribers.length, metrics: this._metrics, portsInitialized: Ports.isInitialized() };
  }
  getMetrics() {
