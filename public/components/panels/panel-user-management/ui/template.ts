...
// ═══════════════════════════════════════════════════════════════
// MODULE: template
// PURPOSE: Panel User Management - Template Barrel
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   renderUserCard from ./templates/card.js
//   renderSkeleton as _renderSkeletonFull from ./templates/skeleton.js
//   renderEditModal from ./templates/modal.js
//
// PROVIDES:
//   renderSkeleton() — exported function
//   renderAuthBlocked() — exported function
//   renderError() — exported function
//   renderUserList() — exported function
//   renderUserDetail() — exported function
...
export const MODULE_ID = 'panel-user-management.ui.template';
...
export function renderAuthBlocked() {
  return '<div class="panel-user-management"><div class="panel-empty-state auth-blocked">' +
    '<div class="empty-icon"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>' +
    '<h3>Acesso Restrito</h3>' +
    '<p>Faca login para gerenciar usuarios</p>' +
...
export function renderUserList(users: Record<string, unknown>[], options: Record<string, unknown>) {
...
export function renderUserDetail(user: Record<string, unknown>, state: Record<string, unknown>) {
  const div = document.createElement('div');
...
export default { renderSkeleton, renderAuthBlocked, renderError, renderUserList, renderUserDetail, renderPagination };
