...
const MODULE_ID = "panels/panel-user-notifications/telemetry/logger";
let _debug = false;
let _logBuffer = [];
...
class Logger {
  ...
  healthCheck() {
    ...
    return { status: passed === 2 ? "HEALTHY" : "DEGRADED", score: `${passed}/2`, checks, version: VERSION, moduleId: MODULE_ID, timestamp: (/* @__PURE__ */ new Date()).toISOString() };
  }
  info2() {
