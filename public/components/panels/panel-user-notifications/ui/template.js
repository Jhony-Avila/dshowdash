...
function renderAuthBlocked() {
  return `
    <div class="panel-user-notifications auth-blocked" data-module="${MODULE_ID}">
      <div class="panel-header"><h2>Notifica\xE7\xF5es</h2></div>
      <div class="panel-content">
        <div class="auth-message">
          ...
          <p>Fa\xE7a login para configurar suas notifica\xE7\xF5es</p>
...
function renderNotifications(settings, isDirty, saving) {
  const s = settings;
  return `
    <div class="panel-user-notifications" data-module="${MODULE_ID}">
      <div class="panel-header">
        <h2>Notifica\xE7\xF5es</h2>
      ...
      <div class="panel-content">
        ...
        <section class="notifications-section">
          <h3>Canais de Notifica\xE7\xE3o</h3>
        ...
        <!-- Se\xE7\xE3o Tipos -->
        <section class="notifications-section">
          <h3>Tipos de Notifica\xE7\xE3o</h3>
          ...
          <div class="frequency-options">
            <label class="radio-option">
              ...
              <span class="radio-label">
                ...
                <small>Receber notifica\xE7\xF5es assim que ocorrerem</small>
              </span>
            </label>
            <label class="radio-option">
              <input type="radio" name="frequency" value="digest" 
                     ...
                     ${s.frequency?.mode === "digest" ? "checked" : ""}>
              <span class="radio-label">
                <strong>Resumo Di\xE1rio</strong>
        ...
        <!-- Se\xE7\xE3o Hor\xE1rio de Sil\xEAncio -->
        <section class="notifications-section">
          <h3>Hor\xE1rio de Sil\xEAncio</h3>
          <div class="quiet-hours">
            <label class="toggle-row">
              <span>Ativar hor\xE1rio de sil\xEAncio</span>
              <label class="toggle-switch">
                <input type="checkbox" 
            ...
            <div class="time-range ${!s.quietHours?.enabled ? "disabled" : ""}">
              ...
              <span class="time-separator">at\xE9</span>
              <div class="time-input">
                <label>Fim</label>
      ...
      <div class="panel-footer">
        <div class="footer-status">
          ${isDirty ? '<span class="unsaved-indicator">Altera\xE7\xF5es n\xE3o salvas</span>' : ""}
        </div>
        <div class="footer-actions">
          ...
          <button class="btn-save" data-action="save" ${!isDirty || saving ? "disabled" : ""}>
            ${saving ? "Salvando..." : "Salvar Altera\xE7\xF5es"}
          </button>
        </div>
      </div>
    </div>
...
var template_default = { renderSkeleton, renderAuthBlocked, renderError, renderNotifications };
const MODULE_ID = "panels-panel-user-notifications-ui-template";
