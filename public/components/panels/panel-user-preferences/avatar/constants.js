...
const MODULE_ID = "panel-user-preferences:avatar-constants";
const AVATAR_TYPES = { FALLBACK: "fallback", IMAGE: "image", GENERATED: "generated" };
const AVATAR_BASES = { ROUND: "round", HEX: "hex", SHIELD: "shield", SQUARE: "square", DIAMOND: "diamond" };
const AVATAR_FRAMES = {
  ...
  HEX_GLOW: { id: "hex_glow", name: "Hex\xE1gono Brilhante", rarity: "rare", color: "#7c3aed" },
  ...
  RAINBOW: { id: "rainbow", name: "Arco-\xEDris", rarity: "legendary", color: "linear-gradient(45deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)" },
...
const AVATAR_BACKGROUNDS = {
  ...
  GRADIENT_SUNSET: { id: "gradient_sunset", name: "P\xF4r do Sol", type: "gradient", value: "linear-gradient(135deg, #f97316 0%, #dc2626 100%)" },
...
const AVATAR_ICONS = {
  ...
  CODE: { id: "code", name: "C\xF3digo", svg: '<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>' },
  ...
  HEART: { id: "heart", name: "Cora\xE7\xE3o", svg: '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0016.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 002 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/>' },
  ...
  USER: { id: "user", name: "Usu\xE1rio", svg: '<path d="M19 21v-2a4 4 0 00-4-4H9a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/>' }
};
const AVATAR_BADGES = {
...
const AVATAR_SIZES = { XS: 24, SM: 32, MD: 40, LG: 56, XL: 80, XXL: 120 };
const DEFAULT_AVATAR_CONFIG = { base: AVATAR_BASES.ROUND, background: "gradient_neon_purple", accentColor: "#7c3aed", icon: "none", frame: "none", badges: [], version: 1 };
const AVATAR_EVENTS = { LOADED: "avatar:loaded", UPDATED: "avatar:updated", SAVED: "avatar:saved", ERROR: "avatar:error", EDIT_OPENED: "avatar:edit:opened", EDIT_CLOSED: "avatar:edit:closed", OPTION_SELECTED: "avatar:option:selected", PREVIEW_CHANGED: "avatar:preview:changed" };
function info() {
  return { moduleId: MODULE_ID, version: VERSION, counts: { types: Object.keys(AVATAR_TYPES).length, bases: Object.keys(AVATAR_BASES).length, frames: Object.keys(AVATAR_FRAMES).length, backgrounds: Object.keys(AVATAR_BACKGROUNDS).length, icons: Object.keys(AVATAR_ICONS).length, badges: Object.keys(AVATAR_BADGES).length } };
}
function healthCheck() {
  return { status: "HEALTHY", moduleId: MODULE_ID, version: VERSION, checks: { constantsLoaded: true } };
}
var constants_default = { AVATAR_TYPES, AVATAR_BASES, AVATAR_FRAMES, AVATAR_BACKGROUNDS, AVATAR_ICONS, AVATAR_BADGES, RARITY_ORDER, RARITY_COLORS, AVATAR_SIZES, DEFAULT_AVATAR_CONFIG, AVATAR_EVENTS, info, healthCheck, VERSION, MODULE_ID };
export {
  AVATAR_BACKGROUNDS,
  AVATAR_BADGES,
  AVATAR_BASES,
