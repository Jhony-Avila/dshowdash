...
// ═══════════════════════════════════════════════════════════════
// MODULE: panels/panel-user-sessions/telemetry/logger
// PURPOSE: Panel User Sessions - Logger
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   (none)
//
...
export const MODULE_ID = 'panels/panel-user-sessions/telemetry/logger';
let _debug = false;
...
export class Logger {
  ...
  constructor(options: Record<string, unknown> = {}) {
    this.prefix = options.prefix || '[user-sessions]';
