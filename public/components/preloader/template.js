...
var template_default = { MODULE_ID, VERSION, getPreloaderTemplate, getMetrics, info, healthCheck, injectPorts, getPorts };
export {
  MODULE_ID,
  VERSION,
