...
// ═══════════════════════════════════════════════════════════════
// MODULE: health
// PURPOSE: Accordion NCS - Health & Info
// ───────────────────────────────────────────────────────────────
// IMPORTS:
//   ACCORDION_INTENTS from /core/runtime/events/catalog/sidebar.events.js
//   VERSION, MODULE_ID, FEATURE_FLAG_KEY, CONTAINER_ID, UARPS_REGION, state, isPortsInitialized from ./constants.js
//   isEnabled from ./feature-flags.js
//   getLegacyHiddenCount from ./legacy-nav.js
...
export function info() {
    ...
    return {
        ...
        accordionLoaded: state.accordion !== null,
        dataSource: (modelInfo && (modelInfo as DynObj).source) || 'none',
...
export default { healthCheck, info };
