...
export const ITEMS = [
  ...
  { id: 'bling', sectionId: 'operacional', title: 'Bling', route: '#/panel-bling', icon: 'box', priority: 2 },
  ...
  { id: 'google-ads', sectionId: 'operacional', title: 'Google Ads', route: '#/panel-ads', icon: 'ads', priority: 10 },
  { id: 'google-drive', sectionId: 'operacional', title: 'Google Drive', route: '#/integrations/google-drive', icon: 'drive', priority: 11 },
  ...
  { id: 'pipedrive', sectionId: 'operacional', title: 'Pipedrive', route: '#/panel-pipedrive', icon: 'pipeline', priority: 16 },
