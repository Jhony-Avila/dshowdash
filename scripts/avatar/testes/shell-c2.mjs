...
const { navegador: b, pagina: p, erros } = await abrir({
  ...
  // mega onda 1301+ (#142): com as6.acess_hub ON o hub substitui os
  // chips §68.3 — este teste cobre o caminho LEGADO (rollback §651);
  // o hub tem cobertura própria em acessorios-v2.mjs
  init: () => { localStorage.setItem('dshow.avst.flags.v1', JSON.stringify({ 'as5.novo_shell': true, 'as6.dock_inferior': false, 'as6.acess_v2': false, 'as6.acess_hub': false })); },
});
