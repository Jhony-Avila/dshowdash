...
async function cenario({ vw, vh, theme, route }) {
  ...
  try {
    ...
    let sidebar = null;
    if (FLAG && m1.sidebar.toggle && m1.sidebar.toggle.vis && m1.sidebar.toggle.rect.x >= 0 && m1.sidebar.toggle.rect.r <= vw && (vw >= 768)) { // só quando o toggle está de fato na tela (flag OFF em tablet: sidebar fora do viewport)
